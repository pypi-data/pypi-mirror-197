...
# from _player_ import play_pitch_segment
import time

import numpy as np
from _basicData import prt_func_time, prt_funcs_time, prt_func_run_num
...
# 随机生成一个音集截段（包括节奏）
def randomSegment(note_num, total_duration, first_note, note_scale=3, style="smooth"):
    ...
    return [random_pitch_set, randomRhythm(note_num, total_duration, style)]

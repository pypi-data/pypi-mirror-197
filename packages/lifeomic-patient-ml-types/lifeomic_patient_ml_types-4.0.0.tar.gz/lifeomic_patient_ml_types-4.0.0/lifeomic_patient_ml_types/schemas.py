...
class ImageSegmentationLabel(BaseModel):
    class Config:
        extra = Extra.forbid
...
class ImageClassificationLabel(BaseModel):
    class Config:
        extra = Extra.forbid
...
class ImageSegmentationExample(BaseModel):
    class Config:
        extra = Extra.forbid
...
class ImageClassificationExample(BaseModel):
    class Config:
        extra = Extra.forbid

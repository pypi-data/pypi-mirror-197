import examples.SIRWithDiffSymptoms.SIRModelDiffSymptoms as M
from apacepy.multi_epidemics import MultiEpidemics
from examples.SIRWithDiffSymptoms.PlotTrajs import plot
...
if __name__ == "__main__":
    ...
    multiModel.simulate(function_to_populate_model=M.build_SIR_model_with_diff_symptoms,
                        n=25,

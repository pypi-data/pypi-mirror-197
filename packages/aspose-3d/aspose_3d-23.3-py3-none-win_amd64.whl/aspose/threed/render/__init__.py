...
class IRenderTarget:
    ...
    @overload
    def create_viewport(self, camera : aspose.threed.entities.Camera, background_color : aspose.pydrawing.Color, rect : aspose.threed.utilities.RelativeRectangle) -> aspose.threed.render.Viewport:
...
class ITexture1D(ITextureUnit):
    ...
    @overload
    def save(self, path : str, format : aspose.pydrawing.imaging.ImageFormat):
    ...
    @overload
    def save(self, bitmap : aspose.pydrawing.Bitmap):
        '''Save the texture content to external file.
    ...
    def to_bitmap(self) -> aspose.pydrawing.Bitmap:
        '''Convert the texture unit to :py:class:`aspose.pydrawing.Bitmap` instance'''
        ...
...
class ITextureCubemap(ITextureUnit):
    ...
    def save(self, side : aspose.threed.render.CubeFace, bitmap : aspose.pydrawing.Bitmap):
        '''Save the specified side to memory'''
        ...
    
    def to_bitmap(self, side : aspose.threed.render.CubeFace) -> aspose.pydrawing.Bitmap:
        '''Convert the texture unit to :py:class:`aspose.pydrawing.Bitmap` instance'''
        ...
...
class RenderState:
    ...
    @property
    def scissor_box(self) -> aspose.pydrawing.Rectangle:
        ...
    
    @scissor_box.setter
    def scissor_box(self, value : aspose.pydrawing.Rectangle):
        ...
...
class TextureData:
    ...
    @staticmethod
    def from_bitmap(bitmap : aspose.pydrawing.Bitmap) -> aspose.threed.render.TextureData:
        '''Convert a :py:class:`aspose.pydrawing.Bitmap` to :py:class:`aspose.threed.render.TextureData`'''
        ...
    
    def to_bitmap(self) -> aspose.pydrawing.Bitmap:
        '''Convert the TextureData to a :py:class:`aspose.pydrawing.Bitmap` instance.'''
        ...

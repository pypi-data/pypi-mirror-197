...
def moveLabelsParser(parser):
    ...
    parser.add_argument(
        ...
        default=1.0,
        dest="PHIFILE_BIN_RATIO",
        help="Ratio of binning level between loaded Phi file and labelled image.\
              If the input Phi file has been obtained on a 500x500x500 image and the labelled image is 1000x1000x1000, this should be 2. Default = 1",
    )

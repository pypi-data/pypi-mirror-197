...
class Fluid:
    ...
    def protocolar_processo_fluid(self, cod_processo: str, id_tipo_processo: str,  mensagem: str, empresa_orig=1, empresa_dest=1, nome_do_nodo ='selecionado_proximo_nodo', abertura_de_processo= False, acao = 0, usuario_destino=2735):
        ''' 

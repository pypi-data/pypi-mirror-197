...
class Gerador:
    ...
    def pwd(self, sistema:str):
        ...
        sistema = str(sistema).lower().strip()
        ...
        sql = f"SELECT * FROM rpa_cofre_senhas WHERE palavra_chave like '%{sistema}%'"

...
(function() {
    ...
    async function onRender(event) {
      ...
      if(showIcon==false){
        ...
        iconParent.style.top=Math.max((body.clientHeight*(iconTop/100)) - (icond.clientHeight/2),0) +'px'
        iconParent.style.left=Math.max((body.clientWidth*(iconLeft/100)) - (icond.clientWidth/2),0) +'px'

...
def streamlit_kpi(
    ...
    animateDuration (int):The Animation Duration in milliseconds, default is 2000.
    """
...
def main():
    ...
    with st.expander('Settings'):
        ...
        with col1:
            ...
            valueText=st.text_input('Text Value:','Argentina')
        ...
        with col4:
            ...
            iconTop=st.slider('Icon Top Position',0,100,38)    
    ...
    streamlit_kpi(key="three",height=height*3,title=title,value=valueText,icon=iconType,progressValue=progress,unit=unit,animate=animate,animateDuration=animationDur,
                  showProgress=showProg,iconTop=iconTop,showIcon=showIcon,
                  iconLeft=iconLeft,iconOpacity=iconOpacity,iconColor=iconColor,
                  backgroundColor=backgroundColor,titleColor=titleColor,valueColor=valueColor,
                  progressColor=progressColor,textAlign=textAlign

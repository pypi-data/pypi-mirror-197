...
def parseArguments():
    ...
    # Optional Arguments
    parser.add_argument("-fp", "--filepath", type=str, default="vectordeprecios_data", help="Filepath and name for the output file (.txt).")
    ...
    parser.add_argument("-author", type=str, default="", help="Requested Author (e.g. 'BCS')")

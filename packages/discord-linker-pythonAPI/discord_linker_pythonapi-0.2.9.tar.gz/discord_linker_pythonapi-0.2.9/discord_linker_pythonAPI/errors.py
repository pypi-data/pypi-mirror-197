...
class PRODUCT_QUANTITY_DISABLED(WP_Error):
    def __init__(self, details:dict, *args, **kwargs):
        WP_Error.sanitize_kwargs(kwargs)
        ...
        super().__init__(
            details,
            *args,
            default_code = "PRODUCT_QUANTITY_DISABLED",
            default_message = "This product's quantity is disabled!",
            **kwargs)
ALL_EXCEPTIONS["PRODUCT_QUANTITY_DISABLED"] = PRODUCT_QUANTITY_DISABLED

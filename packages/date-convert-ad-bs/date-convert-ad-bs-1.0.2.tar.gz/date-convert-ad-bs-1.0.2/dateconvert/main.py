...
# Get the absolute path of the 'common' directory in production
# common_dir = os.path.abspath(os.path.join(
#     os.getcwd(), config['constants_path']))

here = os.path.abspath(os.path.dirname(__file__))

# Load the constants from the JSON file
with open(os.path.join(here, 'constants.json'), 'r') as f:

...
class CustomAppRegistryAttributeGroup(cdk.Stack):
    def __init__(self, scope, id, *, description=None, env=None, stackName=None, tags=None, synthesizer=None, terminationProtection=None, analyticsReporting=None, crossRegionReferences=None, permissionsBoundary=None):
        ...
        my_attribute_group = appreg.AttributeGroup(app, "MyFirstAttributeGroup",
            attribute_group_name="MyAttributeGroupName",
            description="Test attribute group",
            attributes={}
        )

        self.attribute_group = my_attribute_group

custom_attribute_group = CustomAppRegistryAttributeGroup(app, "AppRegistryAttributeGroup")
...
custom_attribute_group.attribute_group.associate_with(associated_app.app_registry_application())
```
...
class TargetApplication(
    ...
    def create_application_stack(
        ...
        *,
        ...
        :param emit_application_manager_url_as_output: (experimental) Whether create cloudFormation Output for application manager URL. Default: - Application containing stacks deployed via CDK.

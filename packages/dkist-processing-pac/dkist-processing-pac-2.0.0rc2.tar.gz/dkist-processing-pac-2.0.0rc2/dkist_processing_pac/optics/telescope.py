...
def compute_coordinate_transform_angle(time) -> float:
    ...
    This is the solar orientation angle offset by 90 degrees so that North/South are aligned with the solar rotation
    axis.
    ...
    # Subtract pi/2 to put North/South in line with *Solar rotation axis* (a la SDO/HMI and Hinode/SP).
    theta -= np.pi / 2.0
...
class Telescope:
    ...
    def generate_inverse_telescope_model(
        self,
        M12: bool = True,
        rotate_to_SDO_HINODE_coordinates: bool = True,
        ...
        rotate_to_SDO_HINODE_coordinates : bool
        ...
        if rotate_to_SDO_HINODE_coordinates:

...
class Meshcat:
    ...
    @overload
    def SetTransform(self, path: str, X_ParentPath: pydrake.math.RigidTransform) -> None: ...
    @overload
...
class SceneGraph(pydrake.systems.framework.LeafSystem):
    ...
    @overload
    def RegisterGeometry(self, context: pydrake.systems.framework.Context, source_id: SourceId, geometry_id: GeometryId, geometry: GeometryInstance) -> GeometryId: ...
    @overload
...
class SceneGraphInspector:
    ...
    def GetPoseInParent(self, geometry_id: GeometryId) -> pydrake.math.RigidTransform: ...
...
class SceneGraph_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_𝓣AutoDiffXd𝓤):
    ...
    def RegisterGeometry(self, frame_id) -> Any: ...
    @overload
    def RegisterGeometry(self, context: pydrake.systems.framework.Context_𝓣AutoDiffXd𝓤, source_id: SourceId, geometry_id: GeometryId, geometry: GeometryInstance) -> GeometryId: ...
    @overload
    def RegisterGeometry(self) -> Any: ...
    @overload
...
class SceneGraph_𝓣Expression𝓤(pydrake.systems.framework.LeafSystem_𝓣Expression𝓤):
    ...
    def RegisterGeometry(self, frame_id) -> Any: ...
    @overload
    def RegisterGeometry(self, context: pydrake.systems.framework.Context_𝓣Expression𝓤, source_id: SourceId, geometry_id: GeometryId, geometry: GeometryInstance) -> GeometryId: ...
    @overload
    def RegisterGeometry(self) -> Any: ...
    @overload

...
_LOGGERSCONFIG = DESCRIPTOR.message_types_by_name['LoggersConfig']
_LOGGERSCONFIG_SINKBYIDENTRY = _LOGGERSCONFIG.nested_types_by_name['SinkByIdEntry']
_LOGGERSCONFIG_LOGGERBYIDENTRY = _LOGGERSCONFIG.nested_types_by_name['LoggerByIdEntry']
_ASYNCCONFIG = DESCRIPTOR.message_types_by_name['AsyncConfig']
_LOGGERCONFIG = DESCRIPTOR.message_types_by_name['LoggerConfig']
_SINKCONFIG = DESCRIPTOR.message_types_by_name['SinkConfig']
_SINKCONFIG_CONSOLE = _SINKCONFIG.nested_types_by_name['Console']
_SINKCONFIG_BASICFILE = _SINKCONFIG.nested_types_by_name['BasicFile']
_SINKCONFIG_ROTATINGFILE = _SINKCONFIG.nested_types_by_name['RotatingFile']
_SINKCONFIG_DAILYFILE = _SINKCONFIG.nested_types_by_name['DailyFile']
_LOGGERCONFIG_LEVEL = _LOGGERCONFIG.enum_types_by_name['Level']

...
_REMOTERYCONFIG = DESCRIPTOR.message_types_by_name['RemoteryConfig']
_PROMETHEUSCONFIG = DESCRIPTOR.message_types_by_name['PrometheusConfig']
_LOGSTASHCONFIG = DESCRIPTOR.message_types_by_name['LogstashConfig']
_FILELOGGER = DESCRIPTOR.message_types_by_name['FileLogger']
_PROMETHEUSCONFIG_PROMETHEUSMODEL = _PROMETHEUSCONFIG.enum_types_by_name['PrometheusModel']

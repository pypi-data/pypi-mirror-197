...
_SEGMENTHEADER = DESCRIPTOR.message_types_by_name['SegmentHeader']
_ENCODEDFIELD = DESCRIPTOR.message_types_by_name['EncodedField']
_VARIANTCODEC = DESCRIPTOR.message_types_by_name['VariantCodec']
_VARIANTCODEC_ZSTD = _VARIANTCODEC.nested_types_by_name['Zstd']
_VARIANTCODEC_TURBOPFOR = _VARIANTCODEC.nested_types_by_name['TurboPfor']
_VARIANTCODEC_LZ4 = _VARIANTCODEC.nested_types_by_name['Lz4']
_VARIANTCODEC_PASSTHROUGH = _VARIANTCODEC.nested_types_by_name['Passthrough']
_BLOCK = DESCRIPTOR.message_types_by_name['Block']
_NDARRAYENCODEDFIELD = DESCRIPTOR.message_types_by_name['NDArrayEncodedField']
_DICTIONARYENCODEDFIELD = DESCRIPTOR.message_types_by_name['DictionaryEncodedField']
_SEGMENTHEADER_HASHTYPE = _SEGMENTHEADER.enum_types_by_name['HashType']
_VARIANTCODEC_TURBOPFOR_SUBCODECS = _VARIANTCODEC_TURBOPFOR.enum_types_by_name['SubCodecs']

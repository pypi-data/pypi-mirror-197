...
_ENVIRONMENTCONFIGSMAP = DESCRIPTOR.message_types_by_name['EnvironmentConfigsMap']
_ENVIRONMENTCONFIGSMAP_ENVBYIDENTRY = _ENVIRONMENTCONFIGSMAP.nested_types_by_name['EnvByIdEntry']
_ENVIRONMENTCONFIG = DESCRIPTOR.message_types_by_name['EnvironmentConfig']
_ENVIRONMENTCONFIG_STORAGEBYIDENTRY = _ENVIRONMENTCONFIG.nested_types_by_name['StorageByIdEntry']
_ENVIRONMENTCONFIG_LIBBYPATHENTRY = _ENVIRONMENTCONFIG.nested_types_by_name['LibByPathEntry']
_VARIANTSTORAGE = DESCRIPTOR.message_types_by_name['VariantStorage']
_LIBRARYPATH = DESCRIPTOR.message_types_by_name['LibraryPath']
_EVENTLOGGERCONFIG = DESCRIPTOR.message_types_by_name['EventLoggerConfig']
_VERSIONSTORECONFIG = DESCRIPTOR.message_types_by_name['VersionStoreConfig']
_VERSIONSTORECONFIG_WRITEOPTIONS = _VERSIONSTORECONFIG.nested_types_by_name['WriteOptions']
_VERSIONSTORECONFIG_WRITEOPTIONS_SYNCDISABLED = _VERSIONSTORECONFIG_WRITEOPTIONS.nested_types_by_name['SyncDisabled']
_VERSIONSTORECONFIG_WRITEOPTIONS_SYNCPASSIVE = _VERSIONSTORECONFIG_WRITEOPTIONS.nested_types_by_name['SyncPassive']
_VERSIONSTORECONFIG_WRITEOPTIONS_SYNCACTIVE = _VERSIONSTORECONFIG_WRITEOPTIONS.nested_types_by_name['SyncActive']
_VERSIONSTORECONFIG_MSGPACK = _VERSIONSTORECONFIG.nested_types_by_name['MsgPack']
_VERSIONSTORECONFIG_STORAGEFAILURESIMULATOR = _VERSIONSTORECONFIG.nested_types_by_name['StorageFailureSimulator']
_READPERMISSIONS = DESCRIPTOR.message_types_by_name['ReadPermissions']
_WRITEPERMISSIONS = DESCRIPTOR.message_types_by_name['WritePermissions']
_PERMISSIONS = DESCRIPTOR.message_types_by_name['Permissions']
_NOCREDENTIALSSTORE = DESCRIPTOR.message_types_by_name['NoCredentialsStore']
_VAULTCREDENTIALSSTORE = DESCRIPTOR.message_types_by_name['VaultCredentialsStore']
_MONGOCREDENTIALSSTORE = DESCRIPTOR.message_types_by_name['MongoCredentialsStore']
_CREDENTIALSSTORE = DESCRIPTOR.message_types_by_name['CredentialsStore']
_LIBRARYDESCRIPTOR = DESCRIPTOR.message_types_by_name['LibraryDescriptor']
_LIBRARYCONFIG = DESCRIPTOR.message_types_by_name['LibraryConfig']
_LIBRARYCONFIG_STORAGEBYIDENTRY = _LIBRARYCONFIG.nested_types_by_name['StorageByIdEntry']

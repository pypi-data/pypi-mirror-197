...
def collate_tpu_embedding_memory(memory_configs: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""TODO: add doc.
...
def collate_tpu_embedding_memory_eager_fallback(memory_configs: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  if not isinstance(memory_configs, (list, tuple)):
    raise TypeError(
        "Expected list for 'memory_configs' argument to "
        "'collate_tpu_embedding_memory' Op, not %r." % memory_configs)
...
def compute_dedup_data_tuple_mask(config: str, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""TODO: add doc.
...
def compute_dedup_data_tuple_mask_eager_fallback(config: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  config = _execute.make_str(config, "config")
  _inputs_flat = []
...
def configure_tpu_embedding_host(common_config: _atypes.TensorFuzzingAnnotation[_atypes.String], memory_config: _atypes.TensorFuzzingAnnotation[_atypes.String], config: str, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""TODO: add doc.
...
def configure_tpu_embedding_host_eager_fallback(common_config: _atypes.TensorFuzzingAnnotation[_atypes.String], memory_config: _atypes.TensorFuzzingAnnotation[_atypes.String], config: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  config = _execute.make_str(config, "config")
...
def configure_tpu_embedding_memory(common_config: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""TODO: add doc.
...
def configure_tpu_embedding_memory_eager_fallback(common_config: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  common_config = _ops.convert_to_tensor(common_config, _dtypes.string)
...
def connect_tpu_embedding_hosts(network_configs: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], name=None):
  r"""TODO: add doc.
...
def connect_tpu_embedding_hosts_eager_fallback(network_configs: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], name, ctx):
  if not isinstance(network_configs, (list, tuple)):
    raise TypeError(
        "Expected list for 'network_configs' argument to "
        "'connect_tpu_embedding_hosts' Op, not %r." % network_configs)
...
def enqueue_tpu_embedding_batch(batch: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], device_ordinal:int=-1, combiners=[], name=None):
  r"""TODO: add doc.
...
def enqueue_tpu_embedding_batch_eager_fallback(batch: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], device_ordinal: int, combiners, name, ctx):
  if not isinstance(batch, (list, tuple)):
    raise TypeError(
        "Expected list for 'batch' argument to "
        "'enqueue_tpu_embedding_batch' Op, not %r." % batch)
...
def execute_tpu_embedding_partitioner(config: str, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""TODO: add doc.
...
def execute_tpu_embedding_partitioner_eager_fallback(config: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  config = _execute.make_str(config, "config")
  _inputs_flat = []
  _attrs = ("config", config)
...
def finalize_tpu_embedding(common_config: _atypes.TensorFuzzingAnnotation[_atypes.String], memory_config: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
  r"""TODO: add doc.
...
def finalize_tpu_embedding_eager_fallback(common_config: _atypes.TensorFuzzingAnnotation[_atypes.String], memory_config: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  common_config = _ops.convert_to_tensor(common_config, _dtypes.string)
  memory_config = _ops.convert_to_tensor(memory_config, _dtypes.string)
  _inputs_flat = [common_config, memory_config]
  _attrs = None
...
def load_all_tpu_embedding_parameters(parameters: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary1: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary2: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary3: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary4: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary5: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary6: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary7: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], config: str, num_shards: int, shard_id: int, name=None):
  r"""TODO: add doc.
...
def load_all_tpu_embedding_parameters_eager_fallback(parameters: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary1: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary2: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary3: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary4: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary5: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary6: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], auxiliary7: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], config: str, num_shards: int, shard_id: int, name, ctx):
  if not isinstance(parameters, (list, tuple)):
    raise TypeError(
        "Expected list for 'parameters' argument to "
        "'load_all_tpu_embedding_parameters' Op, not %r." % parameters)
...
TV_MergeDedupData_integer_type = TypeVar("TV_MergeDedupData_integer_type", _atypes.Int32, _atypes.Int64, _atypes.UInt32, _atypes.UInt64)
TV_MergeDedupData_float_type = TypeVar("TV_MergeDedupData_float_type", _atypes.BFloat16, _atypes.Float32, _atypes.Half)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('merge_dedup_data')
def merge_dedup_data(integer_tensor: _atypes.TensorFuzzingAnnotation[TV_MergeDedupData_integer_type], float_tensor: _atypes.TensorFuzzingAnnotation[TV_MergeDedupData_float_type], tuple_mask: str, config:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def merge_dedup_data_eager_fallback(integer_tensor: _atypes.TensorFuzzingAnnotation[TV_MergeDedupData_integer_type], float_tensor: _atypes.TensorFuzzingAnnotation[TV_MergeDedupData_float_type], tuple_mask: str, config: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  tuple_mask = _execute.make_str(tuple_mask, "tuple_mask")
  if config is None:
    config = ""
  config = _execute.make_str(config, "config")
...
def retrieve_all_tpu_embedding_parameters(NumTables: int, config: str, num_shards: int, shard_id: int, name=None):
  r"""TODO: add doc.
...
def retrieve_all_tpu_embedding_parameters_eager_fallback(NumTables: int, config: str, num_shards: int, shard_id: int, name, ctx):
  NumTables = _execute.make_int(NumTables, "NumTables")
  config = _execute.make_str(config, "config")
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
...
TV_SplitDedupData_integer_type = TypeVar("TV_SplitDedupData_integer_type", _atypes.Int32, _atypes.Int64, _atypes.UInt32, _atypes.UInt64)
TV_SplitDedupData_float_type = TypeVar("TV_SplitDedupData_float_type", _atypes.BFloat16, _atypes.Float32, _atypes.Half)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('split_dedup_data')
def split_dedup_data(input: _atypes.TensorFuzzingAnnotation[_atypes.Variant], integer_type: TV_SplitDedupData_integer_type, float_type: TV_SplitDedupData_float_type, tuple_mask: str, config:str="", name=None):
  r"""TODO: add doc.
...
def split_dedup_data_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Variant], integer_type: TV_SplitDedupData_integer_type, float_type: TV_SplitDedupData_float_type, tuple_mask: str, config: str, name, ctx):
  integer_type = _execute.make_type(integer_type, "integer_type")
  float_type = _execute.make_type(float_type, "float_type")
  tuple_mask = _execute.make_str(tuple_mask, "tuple_mask")
  if config is None:
...
def xla_recv_tpu_embedding_activations(deduplication_data: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_tables: int, config: str, name=None):
  r"""TODO: add doc.
...
def xla_recv_tpu_embedding_activations_eager_fallback(deduplication_data: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_tables: int, config: str, name, ctx):
  num_tables = _execute.make_int(num_tables, "num_tables")
  config = _execute.make_str(config, "config")
...
def xla_recv_tpu_embedding_deduplication_data(config: str, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def xla_recv_tpu_embedding_deduplication_data_eager_fallback(config: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  config = _execute.make_str(config, "config")
  _inputs_flat = []
  _attrs = ("config", config)
...
def xla_send_tpu_embedding_gradients(gradients: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], learning_rates: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], deduplication_data: _atypes.TensorFuzzingAnnotation[_atypes.Variant], config: str, name=None):
  r"""TODO: add doc.
...
def xla_send_tpu_embedding_gradients_eager_fallback(gradients: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], learning_rates: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], deduplication_data: _atypes.TensorFuzzingAnnotation[_atypes.Variant], config: str, name, ctx):
  if not isinstance(gradients, (list, tuple)):
    raise TypeError(
        "Expected list for 'gradients' argument to "
        "'xla_send_tpu_embedding_gradients' Op, not %r." % gradients)

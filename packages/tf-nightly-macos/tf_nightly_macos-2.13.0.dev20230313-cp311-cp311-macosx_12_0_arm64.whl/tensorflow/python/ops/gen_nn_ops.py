...
TV_FusedPadConv2D_T = TypeVar("TV_FusedPadConv2D_T", _atypes.Float32, _atypes.Float64, _atypes.Half)
...
def top_kv2(input: _atypes.TensorFuzzingAnnotation[TV_TopKV2_T], k: _atypes.TensorFuzzingAnnotation[_atypes.Int32], sorted:bool=True, name=None):
  r"""Finds values and indices of the `k` largest elements for the last dimension.
...
def top_kv2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_TopKV2_T], k: _atypes.TensorFuzzingAnnotation[_atypes.Int32], sorted: bool, name, ctx):
  if sorted is None:
    sorted = True
  sorted = _execute.make_bool(sorted, "sorted")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])

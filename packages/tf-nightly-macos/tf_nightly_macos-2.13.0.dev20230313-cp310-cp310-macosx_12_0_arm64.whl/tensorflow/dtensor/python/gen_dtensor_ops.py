...
TV_RelayoutGrad_T = TypeVar("TV_RelayoutGrad_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('relayout_grad')
def relayout_grad(input: _atypes.TensorFuzzingAnnotation[TV_RelayoutGrad_T], forward_input: _atypes.TensorFuzzingAnnotation[TV_RelayoutGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_RelayoutGrad_T]:
  r"""TODO: add doc.
...
def relayout_grad_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_RelayoutGrad_T], forward_input: _atypes.TensorFuzzingAnnotation[TV_RelayoutGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RelayoutGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([input, forward_input], ctx, [])
  (input, forward_input) = _inputs_T
  _inputs_flat = [input, forward_input]
  _attrs = ("T", _attr_T)

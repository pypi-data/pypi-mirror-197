...
def xla_call_module(args, version: int, module: str, Sout, Tout, dim_args_spec=[], platforms=[], name=None):
...
def xla_call_module_eager_fallback(args, version: int, module: str, Sout, Tout, dim_args_spec, platforms, name, ctx):
  version = _execute.make_int(version, "version")
  module = _execute.make_str(module, "module")
  if not isinstance(Sout, (list, tuple)):
    raise TypeError(

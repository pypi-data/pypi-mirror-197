...
class AsyncMySQLClient(ClientBase):
    ...
    async def delete(self, table:str, conditions:List[Tuple[str]], or_cond:Union[List[Tuple[str]],None]=None, show_sql:bool=False):
        # table: table name
        # conditions: query contidion
        #     like [
        #         ('id', '=', 1)
        #     ]
        # or_cond: query contidion
        #     like[
        #         ('id', '=', 1)
        #     ]
        # show_sql: bool, show your sql query

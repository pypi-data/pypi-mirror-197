...
Original file is located at
    https://colab.research.google.com/drive/13G-eBndpsbIioNQEWJrTeypURDczQHfZ
"""
...
DEFAULT_ATTRS = {
    "검사 결과": {"is_hypothetical": True},
    "history": {"is_historical": True},
    "disgnoses": {"is_hypothetical": True},
    "퇴원 기록": {"is_hypothetical": True},
    "family history": {"is_family": True},
    "입원 기록": {"is_hypothetical": True},
    "입원 경과": {"is_hypothetical": True},
    "further_plan": {"is_hypothetical": True}
}


@Language.factory("k_medspacy_sectionizer")
class Sectionizer:
    """
    ...
    def __init__(
        self,
        nlp: Language,
        name: str = "k_medspacy_sectionizer",

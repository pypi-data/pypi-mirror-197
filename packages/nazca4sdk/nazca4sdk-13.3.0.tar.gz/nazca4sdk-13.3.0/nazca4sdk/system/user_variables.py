...
class UserVariables:
    def __init__(self):
        ...
        self._user_variables_saver = UserVariableSaver()

    def get(self, variables: [UserVariableInfo], start_date: str, end_date: str) -> DataFrame:
    ...
    def set(self,  user_variables: [UserVariable]) -> bool:
        """
    ...
    def stats(self, variables: [UserVariableInfo], start_date: str, end_date: str) -> DataFrame:

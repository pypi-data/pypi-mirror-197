...
class AudienceInsightsServiceClient(
    ...
    def generate_insights_finder_report(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateInsightsFinderReportRequest, dict]):
    ...
    def list_audience_insights_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListAudienceInsightsAttributesRequest, dict]):
                The request object. Request message for

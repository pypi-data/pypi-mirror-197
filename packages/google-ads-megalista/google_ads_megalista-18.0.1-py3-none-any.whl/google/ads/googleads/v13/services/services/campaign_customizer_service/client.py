...
class CampaignCustomizerServiceClient(
    ...
    def mutate_campaign_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignCustomizersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CampaignCustomizerOperation]):

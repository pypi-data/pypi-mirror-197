...
class SharedSetServiceClient(metaclass=SharedSetServiceClientMeta):
    ...
    def mutate_shared_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateSharedSetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.SharedSetOperation]):

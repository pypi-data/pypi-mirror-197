...
class KeywordPlanCampaignKeywordServiceClient(
    ...
    def mutate_keyword_plan_campaign_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateKeywordPlanCampaignKeywordsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.KeywordPlanCampaignKeywordOperation]):

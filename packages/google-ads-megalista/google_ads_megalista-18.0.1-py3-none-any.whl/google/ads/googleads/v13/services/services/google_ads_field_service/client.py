...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
    ...
    def get_google_ads_field(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GetGoogleAdsFieldRequest, dict]):
    ...
    def search_google_ads_fields(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.SearchGoogleAdsFieldsRequest, dict]):
                The request object. Request message for

...
class CampaignSharedSetServiceClient(
    ...
    def mutate_campaign_shared_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignSharedSetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CampaignSharedSetOperation]):

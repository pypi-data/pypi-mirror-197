...
class ConversionValueRuleServiceClient(
    ...
    def mutate_conversion_value_rules(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateConversionValueRulesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.ConversionValueRuleOperation]):

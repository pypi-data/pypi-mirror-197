...
class CampaignConversionGoalServiceClient(
    ...
    def mutate_campaign_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignConversionGoalsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CampaignConversionGoalOperation]):

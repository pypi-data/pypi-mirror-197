...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def mutate_ad_group_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdGroupAdsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AdGroupAdOperation]):

...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    def search(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.SearchGoogleAdsRequest, dict]):
    ...
    def search_stream(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.SearchGoogleAdsStreamRequest, dict]):
                The request object. Request message for
    ...
    def mutate(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateGoogleAdsRequest, dict]):
                The request object. Request message for

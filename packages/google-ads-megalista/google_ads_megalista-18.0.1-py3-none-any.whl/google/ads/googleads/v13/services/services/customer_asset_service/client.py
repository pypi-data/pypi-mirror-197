...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def mutate_customer_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCustomerAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CustomerAssetOperation]):

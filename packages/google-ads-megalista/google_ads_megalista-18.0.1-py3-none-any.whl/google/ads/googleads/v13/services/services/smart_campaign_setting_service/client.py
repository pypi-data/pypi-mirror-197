...
class SmartCampaignSettingServiceClient(
    ...
    def mutate_smart_campaign_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateSmartCampaignSettingsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.SmartCampaignSettingOperation]):

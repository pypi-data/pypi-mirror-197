...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def mutate_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateFeedItemsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.FeedItemOperation]):

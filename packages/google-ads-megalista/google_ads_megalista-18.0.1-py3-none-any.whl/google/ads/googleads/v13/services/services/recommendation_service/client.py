...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
    ...
    def apply_recommendation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ApplyRecommendationRequest, dict]):
    ...
    def dismiss_recommendation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.DismissRecommendationRequest, dict]):
                The request object. Request message for

...
class AdGroupCustomizerServiceClient(
    ...
    def mutate_ad_group_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdGroupCustomizersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AdGroupCustomizerOperation]):

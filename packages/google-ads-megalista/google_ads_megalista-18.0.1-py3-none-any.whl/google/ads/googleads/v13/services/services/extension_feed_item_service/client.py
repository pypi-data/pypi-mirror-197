...
class ExtensionFeedItemServiceClient(
    ...
    def mutate_extension_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateExtensionFeedItemsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.ExtensionFeedItemOperation]):

...
from google.ads.googleads.v13.enums.types import reach_plan_ad_length
...
class ListPlannableLocationsResponse(proto.Message):
    ...
    Attributes:
        plannable_locations (Sequence[google.ads.googleads.v13.services.types.PlannableLocation]):
...
class ListPlannableProductsResponse(proto.Message):
    ...
    Attributes:
        product_metadata (Sequence[google.ads.googleads.v13.services.types.ProductMetadata]):
...
class PlannableTargeting(proto.Message):
    ...
    Attributes:
        age_ranges (Sequence[google.ads.googleads.v13.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange]):
        ...
        genders (Sequence[google.ads.googleads.v13.common.types.GenderInfo]):
            Targetable genders for the ad product.
        devices (Sequence[google.ads.googleads.v13.common.types.DeviceInfo]):
            ...
            products.
        networks (Sequence[google.ads.googleads.v13.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork]):
...
class GenerateProductMixIdeasRequest(proto.Message):
    r"""Request message for
    [ReachPlanService.GenerateProductMixIdeas][google.ads.googleads.v13.services.ReachPlanService.GenerateProductMixIdeas].
    ...
    Attributes:
        ...
        budget_micros (int):
            ...
            one unit.
        preferences (google.ads.googleads.v13.services.types.Preferences):
...
class Preferences(proto.Message):
    ...
    Attributes:
        ...
        ad_length (google.ads.googleads.v13.enums.types.ReachPlanAdLengthEnum.ReachPlanAdLength):
...
class GenerateProductMixIdeasResponse(proto.Message):
    ...
    Attributes:
        product_allocation (Sequence[google.ads.googleads.v13.services.types.ProductAllocation]):
...
class GenerateReachForecastRequest(proto.Message):
    ...
    Attributes:
        ...
        planned_products (Sequence[google.ads.googleads.v13.services.types.PlannedProduct]):
...
class ReachCurve(proto.Message):
    ...
    Attributes:
        reach_forecasts (Sequence[google.ads.googleads.v13.services.types.ReachForecast]):
...
class ReachForecast(proto.Message):
    ...
    Attributes:
        ...
        planned_product_reach_forecasts (Sequence[google.ads.googleads.v13.services.types.PlannedProductReachForecast]):
...
class Forecast(proto.Message):
    ...
    Attributes:
        ...
        effective_frequency_breakdowns (Sequence[google.ads.googleads.v13.services.types.EffectiveFrequencyBreakdown]):

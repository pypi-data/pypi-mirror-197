...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
    ...
    def mutate_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AssetOperation]):

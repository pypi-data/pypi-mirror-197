...
class CustomerManagerLinkServiceClient(
    ...
    def mutate_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCustomerManagerLinkRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CustomerManagerLinkOperation]):
    ...
    def move_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MoveManagerLinkRequest, dict]):
                The request object. Request message for

...
class GoogleAdsFailure(proto.Message):
    ...
    Attributes:
        errors (Sequence[google.ads.googleads.v13.errors.types.GoogleAdsError]):
...
class ErrorLocation(proto.Message):
    ...
    Attributes:
        field_path_elements (Sequence[google.ads.googleads.v13.errors.types.ErrorLocation.FieldPathElement]):

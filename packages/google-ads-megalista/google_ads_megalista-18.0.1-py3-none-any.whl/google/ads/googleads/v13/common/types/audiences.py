...
class AudienceExclusionDimension(proto.Message):
    ...
    Attributes:
        exclusions (Sequence[google.ads.googleads.v13.common.types.ExclusionSegment]):
...
class AgeDimension(proto.Message):
    ...
    Attributes:
        age_ranges (Sequence[google.ads.googleads.v13.common.types.AgeSegment]):
...
class GenderDimension(proto.Message):
    ...
    Attributes:
        genders (Sequence[google.ads.googleads.v13.enums.types.GenderTypeEnum.GenderType]):
...
class HouseholdIncomeDimension(proto.Message):
    ...
    Attributes:
        income_ranges (Sequence[google.ads.googleads.v13.enums.types.IncomeRangeTypeEnum.IncomeRangeType]):
...
class ParentalStatusDimension(proto.Message):
    ...
    Attributes:
        parental_statuses (Sequence[google.ads.googleads.v13.enums.types.ParentalStatusTypeEnum.ParentalStatusType]):
...
class AudienceSegmentDimension(proto.Message):
    ...
    Attributes:
        segments (Sequence[google.ads.googleads.v13.common.types.AudienceSegment]):

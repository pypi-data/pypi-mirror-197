...
class TargetingSetting(proto.Message):
    ...
    Attributes:
        target_restrictions (Sequence[google.ads.googleads.v13.common.types.TargetRestriction]):
            The per-targeting-dimension setting to
            restrict the reach of your campaign or ad group.
        target_restriction_operations (Sequence[google.ads.googleads.v13.common.types.TargetRestrictionOperation]):

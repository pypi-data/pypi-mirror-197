...
class PolicyValidationParameter(proto.Message):
    ...
    Attributes:
        ...
        exempt_policy_violation_keys (Sequence[google.ads.googleads.v13.common.types.PolicyViolationKey]):
...
class PolicyTopicEntry(proto.Message):
    ...
    Attributes:
        ...
        evidences (Sequence[google.ads.googleads.v13.common.types.PolicyTopicEvidence]):
            Additional information that explains policy
            finding (e.g. the brand name for a trademark
            finding).
        constraints (Sequence[google.ads.googleads.v13.common.types.PolicyTopicConstraint]):
...
class PolicyTopicEvidence(proto.Message):
    ...
    class DestinationMismatch(proto.Message):
        ...
        Attributes:
            url_types (Sequence[google.ads.googleads.v13.enums.types.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType]):
...
class PolicyTopicConstraint(proto.Message):
    ...
    class CountryConstraintList(proto.Message):
        ...
        Attributes:
            ...
            countries (Sequence[google.ads.googleads.v13.common.types.PolicyTopicConstraint.CountryConstraint]):

...
class ConversionValueRuleSet(proto.Message):
    ...
    Attributes:
        ...
        dimensions (Sequence[google.ads.googleads.v13.enums.types.ValueRuleSetDimensionEnum.ValueRuleSetDimension]):
        ...
        status (google.ads.googleads.v13.enums.types.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus):
            ...
            \*\* Read-only \*\*
        conversion_action_categories (Sequence[google.ads.googleads.v13.enums.types.ConversionActionCategoryEnum.ConversionActionCategory]):

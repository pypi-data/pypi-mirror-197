...
class KeywordPlanAdGroupKeywordServiceClient(
    ...
    def mutate_keyword_plan_ad_group_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateKeywordPlanAdGroupKeywordsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.KeywordPlanAdGroupKeywordOperation]):

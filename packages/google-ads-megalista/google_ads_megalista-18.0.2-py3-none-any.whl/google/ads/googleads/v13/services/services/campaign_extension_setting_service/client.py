...
class CampaignExtensionSettingServiceClient(
    ...
    def mutate_campaign_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignExtensionSettingsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CampaignExtensionSettingOperation]):

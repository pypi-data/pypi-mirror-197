...
class CampaignAssetSetServiceClient(
    ...
    def mutate_campaign_asset_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignAssetSetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CampaignAssetSetOperation]):

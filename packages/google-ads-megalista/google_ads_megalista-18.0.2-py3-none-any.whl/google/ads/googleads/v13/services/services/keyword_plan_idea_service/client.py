...
class KeywordPlanIdeaServiceClient(metaclass=KeywordPlanIdeaServiceClientMeta):
    ...
    def generate_keyword_ideas(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateKeywordIdeasRequest, dict]):
    ...
    def generate_keyword_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateKeywordHistoricalMetricsRequest, dict]):
                The request object. Request message for
    ...
    def generate_ad_group_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateAdGroupThemesRequest, dict]):
                The request object. Request message for

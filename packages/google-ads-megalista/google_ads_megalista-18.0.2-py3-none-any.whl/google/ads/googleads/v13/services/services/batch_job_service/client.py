...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateBatchJobRequest, dict]):
    ...
    def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListBatchJobResultsRequest, dict]):
                The request object. Request message for
    ...
    def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.RunBatchJobRequest, dict]):
                The request object. Request message for
    ...
    def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.AddBatchJobOperationsRequest, dict]):
                The request object. Request message for

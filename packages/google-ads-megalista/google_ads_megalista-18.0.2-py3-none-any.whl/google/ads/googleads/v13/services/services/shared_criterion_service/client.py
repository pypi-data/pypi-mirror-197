...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def mutate_shared_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateSharedCriteriaRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.SharedCriterionOperation]):

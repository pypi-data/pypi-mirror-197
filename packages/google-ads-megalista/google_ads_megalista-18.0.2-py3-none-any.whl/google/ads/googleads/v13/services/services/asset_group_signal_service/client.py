...
class AssetGroupSignalServiceClient(
    ...
    def mutate_asset_group_signals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAssetGroupSignalsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AssetGroupSignalOperation]):

...
class ExperimentServiceClient(metaclass=ExperimentServiceClientMeta):
    ...
    def mutate_experiments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateExperimentsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.ExperimentOperation]):
    ...
    def end_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.EndExperimentRequest, dict]):
                The request object. Request message for
    ...
    def list_experiment_async_errors(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListExperimentAsyncErrorsRequest, dict]):
                The request object. Request message for
    ...
    def graduate_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GraduateExperimentRequest, dict]):
                The request object. Request message for
            ...
            experiment (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            campaign_budget_mappings (Sequence[google.ads.googleads.v13.services.types.CampaignBudgetMapping]):
    ...
    def schedule_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ScheduleExperimentRequest, dict]):
                The request object. Request message for
    ...
    def promote_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.PromoteExperimentRequest, dict]):
                The request object. Request message for

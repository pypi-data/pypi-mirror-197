...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def mutate_keyword_plans(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateKeywordPlansRequest, dict]):
    ...
    def generate_forecast_curve(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateForecastCurveRequest, dict]):
                The request object. Request message for
    ...
    def generate_forecast_time_series(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateForecastTimeSeriesRequest, dict]):
                The request object. Request message for
    ...
    def generate_forecast_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateForecastMetricsRequest, dict]):
                The request object. Request message for
    ...
    def generate_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateHistoricalMetricsRequest, dict]):
                The request object. Request message for

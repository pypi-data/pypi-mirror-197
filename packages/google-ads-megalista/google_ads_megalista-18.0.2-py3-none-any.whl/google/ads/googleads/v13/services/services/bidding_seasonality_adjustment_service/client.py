...
class BiddingSeasonalityAdjustmentServiceClient(
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.BiddingSeasonalityAdjustmentOperation]):

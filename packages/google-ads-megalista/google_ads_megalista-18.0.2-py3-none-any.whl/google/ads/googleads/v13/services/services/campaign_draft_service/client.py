...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
    ...
    def mutate_campaign_drafts(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignDraftsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CampaignDraftOperation]):
    ...
    def promote_campaign_draft(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.PromoteCampaignDraftRequest, dict]):
                The request object. Request message for
    ...
    def list_campaign_draft_async_errors(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListCampaignDraftAsyncErrorsRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v13.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
            resource_name (str):

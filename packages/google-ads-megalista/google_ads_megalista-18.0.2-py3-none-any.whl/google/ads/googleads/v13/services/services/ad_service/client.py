...
class AdServiceClient(metaclass=AdServiceClientMeta):
    ...
    def get_ad(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GetAdRequest, dict]):
    ...
    def mutate_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AdOperation]):

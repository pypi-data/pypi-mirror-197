...
class ConversionActionServiceClient(
    ...
    def mutate_conversion_actions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateConversionActionsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.ConversionActionOperation]):

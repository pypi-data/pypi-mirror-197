...
class KeywordPlanCampaignServiceClient(
    ...
    def mutate_keyword_plan_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateKeywordPlanCampaignsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.KeywordPlanCampaignOperation]):

...
class CustomerCustomizerServiceClient(
    ...
    def mutate_customer_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCustomerCustomizersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CustomerCustomizerOperation]):

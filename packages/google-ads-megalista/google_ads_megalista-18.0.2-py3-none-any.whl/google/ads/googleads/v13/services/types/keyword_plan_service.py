...
class MutateKeywordPlansRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v13.services.types.KeywordPlanOperation]):
...
class MutateKeywordPlansResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v13.services.types.MutateKeywordPlansResult]):
...
class GenerateForecastCurveResponse(proto.Message):
    ...
    Attributes:
        campaign_forecast_curves (Sequence[google.ads.googleads.v13.services.types.KeywordPlanCampaignForecastCurve]):
...
class GenerateForecastTimeSeriesResponse(proto.Message):
    ...
    Attributes:
        weekly_time_series_forecasts (Sequence[google.ads.googleads.v13.services.types.KeywordPlanWeeklyTimeSeriesForecast]):
...
class GenerateForecastMetricsResponse(proto.Message):
    ...
    Attributes:
        campaign_forecasts (Sequence[google.ads.googleads.v13.services.types.KeywordPlanCampaignForecast]):
            List of campaign forecasts.
            One maximum.
        ad_group_forecasts (Sequence[google.ads.googleads.v13.services.types.KeywordPlanAdGroupForecast]):
            List of ad group forecasts.
        keyword_forecasts (Sequence[google.ads.googleads.v13.services.types.KeywordPlanKeywordForecast]):
...
class KeywordPlanMaxCpcBidForecastCurve(proto.Message):
    ...
    Attributes:
        max_cpc_bid_forecasts (Sequence[google.ads.googleads.v13.services.types.KeywordPlanMaxCpcBidForecast]):
...
class KeywordPlanWeeklyTimeSeriesForecast(proto.Message):
    ...
    Attributes:
        keyword_plan_campaign (str):
            ...
            This field is a member of `oneof`_ ``_keyword_plan_campaign``.
        weekly_forecasts (Sequence[google.ads.googleads.v13.services.types.KeywordPlanWeeklyForecast]):
            The forecasts for the Keyword Plan campaign
            at different max CPC bids.
    """
...
class GenerateHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        metrics (Sequence[google.ads.googleads.v13.services.types.KeywordPlanKeywordHistoricalMetrics]):

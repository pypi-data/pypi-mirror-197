...
class CampaignExperimentOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v13.resources.types.CampaignExperiment):
...
class MutateCampaignExperimentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v13.services.types.MutateCampaignExperimentResult]):

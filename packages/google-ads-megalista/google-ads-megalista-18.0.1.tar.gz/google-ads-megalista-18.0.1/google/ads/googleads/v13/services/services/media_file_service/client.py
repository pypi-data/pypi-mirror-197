...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def mutate_media_files(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateMediaFilesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.MediaFileOperation]):

...
class AdGroupExtensionSettingServiceClient(
    ...
    def mutate_ad_group_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdGroupExtensionSettingsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AdGroupExtensionSettingOperation]):

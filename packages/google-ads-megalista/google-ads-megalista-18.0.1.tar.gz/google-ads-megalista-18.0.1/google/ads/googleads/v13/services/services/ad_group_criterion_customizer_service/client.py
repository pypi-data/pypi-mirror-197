...
class AdGroupCriterionCustomizerServiceClient(
    ...
    def mutate_ad_group_criterion_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdGroupCriterionCustomizersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AdGroupCriterionCustomizerOperation]):

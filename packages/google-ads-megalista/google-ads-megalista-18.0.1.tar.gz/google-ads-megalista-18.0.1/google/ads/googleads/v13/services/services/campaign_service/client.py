...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CampaignOperation]):

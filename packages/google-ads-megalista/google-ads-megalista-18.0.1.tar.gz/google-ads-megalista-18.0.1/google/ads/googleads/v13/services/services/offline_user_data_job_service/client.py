...
class OfflineUserDataJobServiceClient(
    ...
    def create_offline_user_data_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.CreateOfflineUserDataJobRequest, dict]):
    ...
    def add_offline_user_data_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.AddOfflineUserDataJobOperationsRequest, dict]):
                The request object. Request message for
            ...
            resource_name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.OfflineUserDataJobOperation]):
    ...
    def run_offline_user_data_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.RunOfflineUserDataJobRequest, dict]):
                The request object. Request message for

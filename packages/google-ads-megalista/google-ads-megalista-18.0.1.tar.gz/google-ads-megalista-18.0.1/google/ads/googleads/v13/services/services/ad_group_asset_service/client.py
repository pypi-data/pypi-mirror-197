...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def mutate_ad_group_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdGroupAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AdGroupAssetOperation]):

...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def mutate_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdGroupsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AdGroupOperation]):

...
class CampaignCriterionServiceClient(
    ...
    def mutate_campaign_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignCriteriaRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CampaignCriterionOperation]):

...
class UploadConversionAdjustmentsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            the upload.
        conversion_adjustments (Sequence[google.ads.googleads.v13.services.types.ConversionAdjustment]):
...
class UploadConversionAdjustmentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            https://developers.google.com/google-ads/api/docs/best-practices/partial-failures
            for more information about partial failure.
        results (Sequence[google.ads.googleads.v13.services.types.ConversionAdjustmentResult]):

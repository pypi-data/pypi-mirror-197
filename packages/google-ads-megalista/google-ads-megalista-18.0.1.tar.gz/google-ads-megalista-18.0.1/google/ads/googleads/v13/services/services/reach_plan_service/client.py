...
class ReachPlanServiceClient(metaclass=ReachPlanServiceClientMeta):
    ...
    def list_plannable_locations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListPlannableLocationsRequest, dict]):
    ...
    def list_plannable_products(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListPlannableProductsRequest, dict]):
    ...
    def generate_product_mix_ideas(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateProductMixIdeasRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v13.services.types.GenerateProductMixIdeasResponse:
    ...
    def generate_reach_forecast(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GenerateReachForecastRequest, dict]):
                The request object. Request message for

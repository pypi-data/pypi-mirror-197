...
class SmartCampaignSuggestServiceClient(
    ...
    def suggest_smart_campaign_budget_options(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.SuggestSmartCampaignBudgetOptionsRequest, dict]):
    ...
    def suggest_smart_campaign_ad(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.SuggestSmartCampaignAdRequest, dict]):
                The request object. Request message for
    ...
    def suggest_keyword_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.SuggestKeywordThemesRequest, dict]):
                The request object. Request message for

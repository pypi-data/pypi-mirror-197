...
class Customer(proto.Message):
    ...
    Attributes:
        ...
        remarketing_setting (google.ads.googleads.v13.resources.types.RemarketingSetting):
            ...
            customer.
        pay_per_conversion_eligibility_failure_reasons (Sequence[google.ads.googleads.v13.enums.types.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason]):

...
class UserListRuleInfo(proto.Message):
    ...
    Attributes:
        ...
        rule_item_groups (Sequence[google.ads.googleads.v13.common.types.UserListRuleItemGroupInfo]):
...
class UserListRuleItemGroupInfo(proto.Message):
    ...
    Attributes:
        rule_items (Sequence[google.ads.googleads.v13.common.types.UserListRuleItemInfo]):
...
class CombinedRuleUserListInfo(proto.Message):
    ...
    Attributes:
        left_operand (google.ads.googleads.v13.common.types.UserListRuleInfo):
            Left operand of the combined rule.
            This field is required and must be populated
            when creating new combined rule based user list.
        right_operand (google.ads.googleads.v13.common.types.UserListRuleInfo):
            Right operand of the combined rule.
            This field is required and must be populated
            when creating new combined rule based user list.
        rule_operator (google.ads.googleads.v13.enums.types.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator):
...
class RuleBasedUserListInfo(proto.Message):
    ...
    Attributes:
        prepopulation_status (google.ads.googleads.v13.enums.types.UserListPrepopulationStatusEnum.UserListPrepopulationStatus):
            ...
            request fails.
        combined_rule_user_list (google.ads.googleads.v13.common.types.CombinedRuleUserListInfo):
        ...
        expression_rule_user_list (google.ads.googleads.v13.common.types.ExpressionRuleUserListInfo):
...
class LogicalUserListInfo(proto.Message):
    ...
    Attributes:
        rules (Sequence[google.ads.googleads.v13.common.types.UserListLogicalRuleInfo]):
...
class UserListLogicalRuleInfo(proto.Message):
    ...
    Attributes:
        ...
        rule_operands (Sequence[google.ads.googleads.v13.common.types.LogicalUserListOperandInfo]):
...
class BasicUserListInfo(proto.Message):
    ...
    Attributes:
        actions (Sequence[google.ads.googleads.v13.common.types.UserListActionInfo]):

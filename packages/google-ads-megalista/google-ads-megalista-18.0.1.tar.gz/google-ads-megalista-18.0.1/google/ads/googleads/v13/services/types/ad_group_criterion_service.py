...
class MutateAdGroupCriteriaRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (Sequence[google.ads.googleads.v13.services.types.AdGroupCriterionOperation]):
...
class MutateAdGroupCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v13.services.types.MutateAdGroupCriterionResult]):

...
class AssetGroupAssetServiceClient(metaclass=AssetGroupAssetServiceClientMeta):
    ...
    def mutate_asset_group_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAssetGroupAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AssetGroupAssetOperation]):

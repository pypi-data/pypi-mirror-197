...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def mutate_ad_parameters(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdParametersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AdParameterOperation]):

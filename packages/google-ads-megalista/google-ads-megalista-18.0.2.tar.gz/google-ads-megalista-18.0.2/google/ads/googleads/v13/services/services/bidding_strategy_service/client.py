...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def mutate_bidding_strategies(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateBiddingStrategiesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.BiddingStrategyOperation]):

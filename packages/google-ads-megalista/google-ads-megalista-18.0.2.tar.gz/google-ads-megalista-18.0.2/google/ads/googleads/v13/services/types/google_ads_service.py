...
class SearchGoogleAdsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v13.services.types.GoogleAdsRow]):
...
class MutateGoogleAdsRequest(proto.Message):
    ...
    Attributes:
        ...
        mutate_operations (Sequence[google.ads.googleads.v13.services.types.MutateOperation]):
...
class MutateGoogleAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        mutate_operation_responses (Sequence[google.ads.googleads.v13.services.types.MutateOperationResponse]):
...
class MutateOperation(proto.Message):
    ...
    Attributes:
        ...
        campaign_draft_operation (google.ads.googleads.v13.services.types.CampaignDraftOperation):
            ...
            This field is a member of `oneof`_ ``operation``.
        campaign_experiment_operation (google.ads.googleads.v13.services.types.CampaignExperimentOperation):
...
class MutateOperationResponse(proto.Message):
    ...
    Attributes:
        ...
        campaign_draft_result (google.ads.googleads.v13.services.types.MutateCampaignDraftResult):
            ...
            This field is a member of `oneof`_ ``response``.
        campaign_experiment_result (google.ads.googleads.v13.services.types.MutateCampaignExperimentResult):

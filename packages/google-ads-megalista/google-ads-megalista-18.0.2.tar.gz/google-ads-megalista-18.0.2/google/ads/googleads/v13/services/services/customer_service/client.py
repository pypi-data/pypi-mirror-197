...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def mutate_customer(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCustomerRequest, dict]):
    ...
    def list_accessible_customers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListAccessibleCustomersRequest, dict]):
                The request object. Request message for
    ...
    def create_customer_client(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.CreateCustomerClientRequest, dict]):
                The request object. Request message for

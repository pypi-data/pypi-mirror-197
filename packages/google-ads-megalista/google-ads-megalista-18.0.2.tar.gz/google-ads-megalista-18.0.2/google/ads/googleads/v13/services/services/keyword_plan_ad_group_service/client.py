...
class KeywordPlanAdGroupServiceClient(
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateKeywordPlanAdGroupsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.KeywordPlanAdGroupOperation]):

...
class CustomerConversionGoalServiceClient(
    ...
    def mutate_customer_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCustomerConversionGoalsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.CustomerConversionGoalOperation]):

...
class ExperimentArmServiceClient(metaclass=ExperimentArmServiceClientMeta):
    ...
    def mutate_experiment_arms(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateExperimentArmsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.ExperimentArmOperation]):

...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def mutate_feed_mappings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateFeedMappingsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.FeedMappingOperation]):

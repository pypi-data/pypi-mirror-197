...
class RemarketingActionServiceClient(
    ...
    def mutate_remarketing_actions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateRemarketingActionsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.RemarketingActionOperation]):

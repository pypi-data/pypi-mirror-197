...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
    ...
    def mutate_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateFeedsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.FeedOperation]):

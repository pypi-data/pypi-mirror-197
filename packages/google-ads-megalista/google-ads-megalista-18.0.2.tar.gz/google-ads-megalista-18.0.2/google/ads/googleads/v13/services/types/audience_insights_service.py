...
class ListAudienceInsightsAttributesRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        dimensions (Sequence[google.ads.googleads.v13.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]):
...
class ListAudienceInsightsAttributesResponse(proto.Message):
    ...
    Attributes:
        attributes (Sequence[google.ads.googleads.v13.services.types.AudienceInsightsAttributeMetadata]):
...
class BasicInsightsAudience(proto.Message):
    ...
    Attributes:
        country_location (Sequence[google.ads.googleads.v13.common.types.LocationInfo]):
            Required. The countries for this audience.
        sub_country_locations (Sequence[google.ads.googleads.v13.common.types.LocationInfo]):
        ...
        age_ranges (Sequence[google.ads.googleads.v13.common.types.AgeRangeInfo]):
            Age ranges for the audience.  If absent, the
            audience represents all people over 18 that
            match the other attributes.
        user_interests (Sequence[google.ads.googleads.v13.common.types.UserInterestInfo]):
            User interests defining this audience.
            Affinity and In-Market audiences are supported.
        topics (Sequence[google.ads.googleads.v13.services.types.AudienceInsightsTopic]):

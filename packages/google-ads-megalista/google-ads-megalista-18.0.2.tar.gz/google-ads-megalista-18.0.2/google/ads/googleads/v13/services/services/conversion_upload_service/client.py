...
class ConversionUploadServiceClient(
    ...
    def upload_click_conversions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.UploadClickConversionsRequest, dict]):
    ...
    def upload_call_conversions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.UploadCallConversionsRequest, dict]):
                The request object. Request message for

...
class Recommendation(proto.Message):
    ...
    Attributes:
        ...
        optimize_ad_rotation_recommendation (google.ads.googleads.v13.resources.types.Recommendation.OptimizeAdRotationRecommendation):
            ...
            This field is a member of `oneof`_ ``recommendation``.
        callout_extension_recommendation (google.ads.googleads.v13.resources.types.Recommendation.CalloutExtensionRecommendation):
            Output only. The Callout extension
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        sitelink_extension_recommendation (google.ads.googleads.v13.resources.types.Recommendation.SitelinkExtensionRecommendation):
            Output only. The Sitelink extension
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        call_extension_recommendation (google.ads.googleads.v13.resources.types.Recommendation.CallExtensionRecommendation):
    ...
    class CampaignBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            budget_options (Sequence[google.ads.googleads.v13.resources.types.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption]):
    ...
    class TargetCpaOptInRecommendation(proto.Message):
        ...
        Attributes:
            options (Sequence[google.ads.googleads.v13.resources.types.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption]):
    ...
    class CalloutExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v13.common.types.CalloutFeedItem]):
    ...
    class SitelinkExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v13.common.types.SitelinkFeedItem]):
    ...
    class CallExtensionRecommendation(proto.Message):
        ...
        Attributes:
            recommended_extensions (Sequence[google.ads.googleads.v13.common.types.CallFeedItem]):
    ...
    class UseBroadMatchKeywordRecommendation(proto.Message):
        ...
        Attributes:
            keyword (Sequence[google.ads.googleads.v13.common.types.KeywordInfo]):

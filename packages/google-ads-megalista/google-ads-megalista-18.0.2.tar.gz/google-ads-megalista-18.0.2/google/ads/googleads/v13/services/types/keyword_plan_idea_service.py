...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    Attributes:
        ...
        keyword_plan_network (google.ads.googleads.v13.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            ...
            will be used.
        keyword_annotation (Sequence[google.ads.googleads.v13.enums.types.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation]):
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v13.services.types.GenerateKeywordIdeaResult]):
...
class GenerateKeywordHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v13.services.types.GenerateKeywordHistoricalMetricsResult]):
...
class GenerateAdGroupThemesResponse(proto.Message):
    ...
    Attributes:
        ad_group_keyword_suggestions (Sequence[google.ads.googleads.v13.services.types.AdGroupKeywordSuggestion]):
            A list of suggested AdGroup/keyword pairings.
        unusable_ad_groups (Sequence[google.ads.googleads.v13.services.types.UnusableAdGroup]):

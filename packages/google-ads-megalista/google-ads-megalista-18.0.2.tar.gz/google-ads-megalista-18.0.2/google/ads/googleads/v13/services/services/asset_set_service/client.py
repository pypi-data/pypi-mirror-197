...
class AssetSetServiceClient(metaclass=AssetSetServiceClientMeta):
    ...
    def mutate_asset_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAssetSetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v13.services.types.AssetSetOperation]):

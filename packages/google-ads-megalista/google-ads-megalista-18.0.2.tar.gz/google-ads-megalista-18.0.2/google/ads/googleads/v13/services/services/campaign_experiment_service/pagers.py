...
class ListCampaignExperimentAsyncErrorsPager:
    ...
    :class:`google.ads.googleads.v13.services.types.ListCampaignExperimentAsyncErrorsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v13.services.types.ListCampaignExperimentAsyncErrorsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            request (:class:`google.ads.googleads.v13.services.types.ListCampaignExperimentAsyncErrorsRequest`):
                The initial request object.
            response (:class:`google.ads.googleads.v13.services.types.ListCampaignExperimentAsyncErrorsResponse`):

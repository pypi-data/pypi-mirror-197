...
class Ranalysis:
    ...
    def __init__(self,model, X_train, y_train, X_test, y_test,X_val=None, y_val=None):
        ...
        if X_val is not None and y_val is not None:
            ...
            self.X_val = X_val
            self.y_val = y_val
    def residual_analysis(self, train_or_test_or_val:str, remove_vars=None, figsize=(1400, 1000), bins=30, smooth_order=5):
        """
    ...
    def get_metrics_summary(self, model_name:str, sample_weight=None, multioutput='uniform_average')-> pd.DataFrame:
        ...
        metrics_dict["N_Vars"] = len(self.model.feature_names_in_)
        metrics_dict["Vars"] = str(self.model.feature_names_in_.to_list())
        metrics_dict["N_Samples"] = self.X_train.shape[0]

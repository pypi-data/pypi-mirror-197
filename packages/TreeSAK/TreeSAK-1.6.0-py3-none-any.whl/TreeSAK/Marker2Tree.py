...
def Marker2Tree(args):
    ...
    best_hit_id_by_marker_dir            = '%s/s02_identified_marker_1_id'                          % op_dir
    best_hit_seq_by_marker_dir           = '%s/s03_identified_marker_2_seq'                         % op_dir
    best_hit_seq_by_marker_dir_renamed   = '%s/s04_identified_marker_3_seq_renamed'                 % op_dir
    best_hit_aln_by_marker_dir           = '%s/s05_identified_marker_4_aln'                         % op_dir
    best_hit_aln_by_marker_dir_trimmed   = '%s/s06_identified_marker_5_aln_trimmed'                 % op_dir
    best_hit_aln_by_marker_dir_trimmed_c = '%s/s07_identified_marker_5_aln_trimmed_concatenated'    % op_dir

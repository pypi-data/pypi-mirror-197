...
def AssessMarkerPA(args):
    ...
    for each_cutoff in cutoff_to_qualified_marker_dict:
        ...
        pwd_qualified_marker_phy       = '%s/qualified_marker_PA_%s.phy'            % (op_dir, each_cutoff)
        pwd_qualified_marker_partition = '%s/qualified_marker_PA_%s_partition.txt'  % (op_dir, each_cutoff)

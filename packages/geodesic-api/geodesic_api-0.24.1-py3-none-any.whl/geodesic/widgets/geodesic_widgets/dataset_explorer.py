...
class DatasetExplorerWidget(ipywidgets.VBox):
    ...
    def _setup_lhs(self):
        self.lhs = ipywidgets.VBox(
            ...
            layout=ipywidgets.Layout(
                align_items="center", border="1px solid #444", padding="10px"
            ),
        )
    ...
    def _redraw_imshow(self, _):
        ...
        if renderer_props["renderer"] == "colormap":
            ...
            self.ax.imshow(
                self.warp_results[band_idx], **renderer_props["imshow_kwargs"]
            )
        else:
...
class RenderingBar(ipywidgets.VBox):
    def __init__(self, **kwargs):
        ...
        super().__init__(
            [self.select_renderer, self.colormap_panel, self.rgb_panel], **kwargs
        )
    ...
    def _setup_rgb_rendering(self, bands_list=[]):
        ...
        self.rgb_panel = ipywidgets.VBox(
            [self.rgb_label, vbox], layout={"align_items": "center"}
        )

...
class AssetBandsLineWidget(ipywidgets.VBox):
    ...
    def __init__(self, **kwargs):
        self.asset_text = ipywidgets.Text(
            placeholder="asset name", description="Asset:"
        )
...
class AssetBandsWidget(ipywidgets.VBox):
    def __init__(self, **kwargs):
        ...
        self._clear_button = ipywidgets.Button(
            description="Clear", layout={"width": "70px"}
        )
    ...
    def asset_bands(self):
        ...
        for row in self.children[1:]:
            ...
            asset_bands.append(
                {"asset": asset_bands_line.asset, "bands": asset_bands_line.bands}
            )
        return asset_bands

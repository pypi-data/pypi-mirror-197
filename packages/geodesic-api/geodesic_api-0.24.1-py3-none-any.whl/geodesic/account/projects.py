...
def create_project(
    name: str, alias: str, description: str, keywords: list = []
) -> "Project":
    ...
    """
    project = Project(
        name=name, alias=alias, description=description, keywords=keywords
    )
...
class Project(_APIObject):
    ...
    name = _RegexDescr(
        regex=project_name_re, doc="the name of this project, unique to the user"
    )

...
class Credential(_APIObject):
    ...
    def create(self, ignore_if_exists=True):
        ...
        try:
            raise_on_error(
                self._client.post("", name=self.name, type=self.type, data=enc_data)
            )
    ...
    @staticmethod
    def from_gcp_service_account(
        *, name: str, key: Union[str, dict] = None
    ) -> "Credential":
    ...
    @staticmethod
    def from_azure_connection_string(
        *, name: str, connection_string: str = None
    ) -> "Credential":
        """creates new Azure Storage Account Credential
        ...
        if connection_string is None:
            connection_string = getpass(
                prompt="Azure Storage Account Connection String: "
            )
    ...
    @staticmethod
    def from_basic_auth(
        *, name: str, username: str, password: str = None
    ) -> "Credential":

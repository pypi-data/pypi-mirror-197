...
class ShrinkageOptimizer:
    ...
    def optimize_shrinkage_prior_strength(neighborhood_experiment_guide_sets: Union[ExperimentGuideSets, None],
        ...
        for rep_i in replicate_indices:
            ...
            res = scipy.optimize.differential_evolution(weighted_objective_function_of_all_guides_p, bounds=[(0.000001, 1000),(0.000001, 1000)], callback=store_values, tol=0.05, workers=cores) 

...
def perform_adjustment(
    ...
    def add_shrinkage_result_to_guide(each_guide: Guide,
        ...
        guide_count_posterior_LFC_samples_normalized_list_rescaled = np.asarray([np.log(np.exp(guide_count_posterior_LFC_samples_normalized_list[rep_i]) * ((each_guide.sample_population_normalized_count_reps[rep_i] + each_guide.control_population_normalized_count_reps[rep_i]) * negative_control_guide_control_population_total_normalized_counts_reps[rep_i]) / ((negative_control_guide_sample_population_total_normalized_counts_reps[rep_i] + negative_control_guide_control_population_total_normalized_counts_reps[rep_i]) * each_guide.control_population_normalized_count_reps[rep_i])) for rep_i in replicate_indices])

...
class ThreadListAPIView(APIView):
    ...
    def get(self, *args, user_info=None, request_params, **kwargs):
        ...
        filter_fields = request_params.pop('filter_fields', [
            "id", "category_name", "classify_name", "show_value", "title", "subtitle", "summary", "user_name",
            "avatar", "author", "cover", "photos", "video", "nickname", "weight", "views", "plays", "comments",
            "likes", "favorite", "shares", "create_time", "update_time",
        ])

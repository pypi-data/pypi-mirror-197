...
class MbService(object):
    ...
    def get_table_size(self, table):
        results = self.db.fetch_one(self.query_builder.select_table_size(table))
    ...
    def get_survey_page(self, skip: int, limit: int) -> [MbSurvey]:
        if MigrationProperties.SURVEY_QUERY is None:
            ...
            MigrationLog.logger.info(f"Migrating surveys using query: \n{MigrationProperties.SURVEY_QUERY}")

...
class CruiseProcessor(object):
    ...
    def __init__(self):
        ...
        self.migrating_surveys: [MigratingSurvey] = set()
    ...
    def __process_project(self, project_crate: CruiseProjectCrate):
        return self.project_service.get_new_or_existing_project(project_crate.project)
    ...
    def __validate_dataset_entry(self, dataset: Dataset, survey, scientists, sources, platforms, instruments, project):
        ...
        for instrument in instruments:
            if instrument is None:
                ...
                valid = False
        if project is None:
            self.__fail_dataset(dataset, "project")
            valid = False
        if not valid:

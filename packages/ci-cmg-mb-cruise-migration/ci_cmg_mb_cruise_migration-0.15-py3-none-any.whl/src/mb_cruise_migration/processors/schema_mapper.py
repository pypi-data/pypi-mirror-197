...
class SchemaMapper(object):
    ...
    def load_dataset_parameters(mb_survey: MbSurvey, survey_reference: SurveyReference) -> [CruiseDatasetParameter]:
        ...
        if survey_reference.download_url is not None:
    ...
    def load_cruise_survey(mb_survey: MbSurvey) -> CruiseSurvey:
        start_time = mb_survey.start_time.strftime('%d-%b-%y') if mb_survey.start_time else None
        end_time = mb_survey.end_time.strftime('%d-%b-%y') if mb_survey.end_time else None
    ...
    def load_cruise_file(file_crate: MbFileCrate, prefab: Prefab) -> CruiseFile:
        ...
        # start_time = file_crate.mb_info.start_time
        # collection_date = start_time.strftime('%d-%b-%y %H:%M:%S') if start_time else None

...
def init(is_sentinel: bool = False, sentinel_host_and_port: str = None, sentinel_master_name: str = None, single_host: str = None, single_port: int = None, redis_passwd: str = None, sentinel_passwd: str = None) -> RedisManager:
    global __client__
    if __client__ is None:
        __client__ = RedisManager(is_sentinel=is_sentinel, sentinel_host_and_port=sentinel_host_and_port, sentinel_master_name=sentinel_master_name, single_host=single_host, single_port=single_port, redis_passwd=redis_passwd, sentinel_passwd=sentinel_passwd)
    return __client__

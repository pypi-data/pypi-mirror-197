...
class SentioSensors:
    ...
    def updateData(self):      
        ...
        if self._outdoorTemp == Defaults.InvalidFP2_100:
            self._outdoorTemp = None
        self._hcsourceState = SentioHeatingStates(self._api.readRegister(SentioRegisterMap.HCSourceState))
    ...
    def device_type(self) -> SentioDeviceType:
        return "Shizzle - {0}".format(self._deviceType)

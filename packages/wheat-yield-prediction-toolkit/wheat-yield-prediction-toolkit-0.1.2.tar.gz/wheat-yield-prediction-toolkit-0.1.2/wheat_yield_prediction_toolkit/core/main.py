...
path_to_save_yield = os.path.join(RAW_DATA, "yield-data", "historical-yiled-data-final.parquet")
...
path_to_save_sat = os.path.join(RAW_DATA, "sat-data", "historical-sat-data-final.parquet")

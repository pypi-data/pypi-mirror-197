...
@dataclass
class DownloadTableDataResult:
    """
    The result of downloading resources from a table.

    :param downloaded_files: A list of files containing the downloaded table data.
    :param schema_version: Version of the schema that records in the table conform to.
...
@dataclass
class GetTableDataResult:
    """
    The result of getting resources from a table.

    :param resources: A list of resources containing the URLs from where the files containing the table data can be downloaded.
    :param schema_version: Version of the schema that records in the table conform to.
    :param timestamp: Timestamp (in UTC) that identifies the table state.
    :param job_id: The ID of the executed backend job.
    """

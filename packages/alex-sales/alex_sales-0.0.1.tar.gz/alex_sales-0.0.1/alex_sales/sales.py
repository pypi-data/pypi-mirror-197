# Copiar todas las clases que teníamos en el ORM.ipynb

from alex_sales.settings import DB_settings
import mysql.connector as sql # importar la clase para poderse conectarse a la BD

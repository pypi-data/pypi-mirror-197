...
class Summary:
    ...
    def trasform_datetime(self):
        ...
        self.df_master['classification_date'] = pd.to_datetime(s.df_master.classified_at).dt.date
        self.df_master['classification_time'] = pd.to_datetime(s.df_master.classified_at).dt.time
        
        self.df_master['created_at_date'] = pd.to_datetime(s.df_master.classified_at).dt.date
        self.df_master['created_at_time'] = pd.to_datetime(s.df_master.classified_at).dt.time
        
        
        self.df_master['updated_at_date'] = pd.to_datetime(s.df_master.classified_at).dt.date
        self.df_master['updated_at_time'] = pd.to_datetime(s.df_master.classified_at).dt.time     

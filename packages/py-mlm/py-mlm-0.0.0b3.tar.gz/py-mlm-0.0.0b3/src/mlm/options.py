...
def get_opts(prog_name="mlm"):
    ...
    group.add_argument(
        ...
        "--latest",
        action="store_true",
        help="""List your latest tracked anime to resume watching.""",
    )
    group.add_argument(
        "-o",
        "--open",
    ...
    group.add_argument(
        ...
        action="store_true",
        help="""
        List all titles in your library. If the chosen title is being tracked
        then the last tracked episode will begin playing in mpv. This will also
        turn on tracking for mlm.lua so when you close the video it will be
        recorded in your library and your history. If this is a title that has
        no tracked episode then a list of all episodes found in the title's dir

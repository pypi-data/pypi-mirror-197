...
class GenerateTrainData:
    ...
    def get_trend_season(self, label_name):
        result = sm.tsa.seasonal_decompose(self.df[label_name], model='additive')
        self.df['trend'] = result.trend
        self.df['trend'] = self.df['trend'].fillna(0)
        self.df['season'] = result.seasonal

            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        libABCD.logger.warning('Function call error {} for message {} from {}'.format(e,jsdata,connection.getpeername()))
            except Exception as e:
                libABCD.logger.warning('Got error {} while parsing {}'.format(e,json_str))
                break
    except Exception as e:
        libABCD.logger.error('Unknown error in parsing {}',e)

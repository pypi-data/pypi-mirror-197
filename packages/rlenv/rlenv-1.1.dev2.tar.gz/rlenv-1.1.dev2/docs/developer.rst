...
.. warning::
   ...
   `rlenv` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `rlenv`, and type::

    conda env create -f environment.yml

This will create a conda virtual environment called `rlenv-dev` with all
the Accenta Gym Environment dependencies and a few useful packages for development and
interaction.
...
* On Windows, in your Anaconda Prompt, run ``activate rlenv-dev``
* On MacOSX and Linux, in your Terminal, run ``source activate rlenv-dev``
...
type::
    ...
    conda list -n rlenv-dev

If later you want to leave the `rlenv-dev` virtual environment:
...
then on, all the Accenta Gym Environment binaries and the library itself will be
...
To search for bugs or report them, please use the Bug Tracker at:
    ...
    https://gitlab.com/ens-data-challenge/accenta-gym-environment/issues
...
.. _available on GitHub: https://gitlab.com/ens-data-challenge/accenta-gym-environment
...
.. _TODO.md: https://gitlab.com/ens-data-challenge/accenta-gym-environment/blob/master/TODO.md

...
from azure_recommendations_13.recommendation.utils import get_rg_name

import logging

from azure_recommendations_13.recommendation import utils
        ...
        for subscription, vms in vm_list.items():
            for vm in vms:
                ...
                if os_disk_type == 'Premium_LRS':
                    ...
                    # print(price_premium)
                    price_standard = get_cost_data(vm.location, 'Standard SSD Managed Disks', 'E4 LRS')

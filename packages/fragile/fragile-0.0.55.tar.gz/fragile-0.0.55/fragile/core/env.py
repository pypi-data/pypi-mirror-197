...
class PlangymEnv(EnvironmentAPI):
    ...
    def reset(
        ...
        **kwargs,
        ...
        if inplace:
            self.update(states=new_states, observs=new_observs, infos=infos, inactives=True)
        else:
            return dict(states=new_states, observs=new_observs, infos=infos)

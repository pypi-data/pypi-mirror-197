...
def _validate_flan_t5_dataset(path: Path):
    try:
        with open(path, "r") as f:
            ...
            raise InvalidDatasetError(
                "🛑 CSV in wrong format. Please make sure there are two columns. 🛑"
            )
...
def upload_dataset(
    ...
    elif training_type == DatasetTrainingType.FLAN_T5:
        _validate_flan_t5_dataset(path)

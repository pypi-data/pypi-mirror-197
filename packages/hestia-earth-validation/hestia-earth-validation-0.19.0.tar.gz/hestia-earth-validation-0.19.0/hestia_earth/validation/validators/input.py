...
def validate_animalFeed_requires_fate(cycle: dict, site: dict, list_key: str = 'inputs'):
    ...
    def validate(values: tuple):
        ...
        return term_type not in FEED_TERM_TYPES or input.get('fate') is not None or {
            'level': 'error',
            'dataPath': f".{list_key}[{index}].fate",

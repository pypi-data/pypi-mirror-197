...
class CanonicalQAE:
    ...
    def __init__(self, problem: AEProblem):
        ...
        problem: The amplitude estimation problem.
    ...
    def init_env(self) -> None:
        """
        Setup the initial environment, including the quantum register used by the algorithm.
        """
        self.env = QEnv()
    ...
    def setup_qreg(self) -> None:
        ...
        The working and ancillary qubits are all initialized to |0>.
    ...
    def prepare_ctrlQ(self) -> None:
        ...
        use ctrlQ(working, ancilla) if Q acts on working qubits.
        """
    ...
    def measure_ancillas(self) -> dict:
        ...
        """
        #self.check_status()
        # check backend of the environment is valid
        # if self.env.backendName != BackendName.LocalBaiduSim2:
        #     raise ValueError("The backend of the environment is not valid.")

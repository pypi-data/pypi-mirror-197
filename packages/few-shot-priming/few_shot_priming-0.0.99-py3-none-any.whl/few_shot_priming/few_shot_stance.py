...
def run_experiment_fewshot(params=None, offline=False, validate=True):
    """
...
if __name__ == "__main__":
    ...
    if args.validate:
        run_experiment_fewshot(params=None, offline=offline, validate=True)

    if args.test:
        run_experiment_fewshot(params=None, offline=offline, validate=False)

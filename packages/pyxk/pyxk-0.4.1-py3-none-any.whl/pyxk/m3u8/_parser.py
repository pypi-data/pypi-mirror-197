...
class M3U8Parse:
    ...
    def print_parsing_result(self):
        ...
        information = [
            ...
            f"Output: [magenta]{self.m3u.output}[/]",
            "Result: [yellow]==>[/] " \
        ...
        information.insert(
            0,
            panel.Panel(columns.Columns([str(self.url)], expand=True, align="center"))
        )
        information = panel.Panel(columns.Columns(information, expand=True), border_style="yellow")

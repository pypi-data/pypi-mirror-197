...
def _convert_measure_arg(  # pylint: disable=too-many-return-statements
    *, java_api: JavaApi, cube_name: str, arg: Any
    ...
    if isinstance(arg, HasCoordinates) and isinstance(
        arg._coordinates, MeasureCoordinates
    ):
        return arg._coordinates.measure_name

...
class App(object):
    def __init__(self):
        ...
        file_menu.add_command(label='Create a new project',command=lambda: ProjectCreatorPopUp())
        file_menu.add_command(label='Load project', command=lambda: LoadProjectPopUp())
        file_menu.add_separator()
        file_menu.add_command(label='Exit', command=self.root.destroy)

        batch_process_menu = Menu(menu)
        menu.add_cascade(label='Process Videos', menu=batch_process_menu)
        batch_process_menu.add_command(label='Batch pre-process videos', command= lambda: BatchPreProcessPopUp())
        ...
        video_process_menu.add_command(label='Clip videos',command=ClipVideoPopUp)
        video_process_menu.add_command(label='Clip video into multiple videos', command=MultiShortenPopUp)
        video_process_menu.add_command(label='Crop videos',command=CropVideoPopUp)
        video_process_menu.add_command(label='Multi-crop',command=MultiCropPopUp)
        video_process_menu.add_command(label='Downsample videos',command=DownsampleVideoPopUp)
        video_process_menu.add_command(label='Get mm/ppx',command = CalculatePixelsPerMMInVideoPopUp)
        ...
        video_process_menu.add_cascade(label='Visualize pose-estimation in folder...', command=VisualizePoseInFolderPopUp)
        ...
        video_process_menu.add_cascade(label='Change formats...',menu=format_menu)
        ...
        help_menu.add_cascade(label="Links",menu=links_menu)
        help_menu.add_command(label='About', command=AboutSimBAPopUp)

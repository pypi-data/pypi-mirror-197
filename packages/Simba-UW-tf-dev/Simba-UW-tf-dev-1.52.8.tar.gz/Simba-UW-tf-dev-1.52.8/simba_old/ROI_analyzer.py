...
class ROIAnalyzer(ConfigReader):
    ...
    def __init__(self,
        ...
        if data_path != None:
            ...
            if len(self.files_found) == 0:
                print(f'SIMBA ERROR: No data files found in {self.input_folder}')
                raise ValueError(f'SIMBA ERROR: No data files found in {self.input_folder}')
    ...
    def read_roi_dfs(self):
        ...
        if not os.path.isfile(os.path.join(self.logs_path, Paths.ROI_DEFINITIONS.value)):
            print('SIMBA ERROR: No ROI definitions were found in your SimBA project. Please draw some ROIs before analyzing your ROI data')
            raise FileNotFoundError('SIMBA ERROR: No ROI definitions were found in your SimBA project. Please draw some ROIs before analyzing your ROI data')
        else:

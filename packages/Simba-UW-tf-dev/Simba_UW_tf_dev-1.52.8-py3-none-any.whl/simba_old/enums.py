...
class Options(Enum):
    ...
    DLC_TRACKING_TYPE_OPTIONS = ['skeleton', 'box', 'ellipse']
    POSE_ESTIMATION_DATA_TYPES = ['CSV (DLC/DeepPoseKit)','JSON (BENTO)','H5 (multi-animal DLC)', 'SLP (SLEAP)', 'CSV (SLEAP)', 'H5 (SLEAP)', 'TRK (multi-animal APT)', 'MAT (DANNCE 3D)']

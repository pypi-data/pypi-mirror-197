...
def roiAnalysis(inifile, inputcsv):
    ...
    for i in filesFound:
        ...
        file_directory, CurrentVideoName, extension = get_file_path_parts(i)
        print('Analysing ' + str(CurrentVideoName) + '...')
        videoSettings, _, currFps = read_video_info(vidinfDf=vidinfDf, currVidName=str(CurrentVideoName))

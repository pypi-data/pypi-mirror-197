...
class ImportFrameDirectoryPopUp(PopUpMixin):
    ...
    def run(self):
        if not os.path.isdir(self.frame_folder.folder_path):
            print(f'SIMBA ERROR: {self.frame_folder.folder_path} is not a valid directory.')
            raise ValueError(f'SIMBA ERROR: {self.frame_folder.folder_path} is not a valid directory.')
...
class InterpolatePopUp(PopUpMixin):
    ...
    def run(self):
        if not os.path.isdir(self.input_dir.folder_path):
            print(f'SIMBA ERROR: {self.input_dir.folder_path} is not a valid directory.')
            raise ValueError(f'SIMBA ERROR: {self.input_dir.folder_path} is not a valid directory.')

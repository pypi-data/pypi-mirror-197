...
import functools
from simba.enums import Formats, Paths, Defaults
...
class ROIPlotMultiprocess(ConfigReader):
    ...
    def __init__(
        ...
        if not os.path.isfile(self.roi_analyzer.files_found[0]):
            print(f'SIMBA ERROR: Could not find the file at path {self.roi_analyzer.files_found[0]}. Please make sure you have corrected body-part outliers or indicated that you want to skip outlier correction')
            raise FileNotFoundError(f'SIMBA ERROR: Could not find the file at path {self.roi_analyzer.files_found[0]}. Please make sure you have corrected body-part outliers or indicated that you want to skip outlier correction')

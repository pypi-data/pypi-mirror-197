...
#from features_scripts.unit_tests import read_video_info_csv
...
def plotsklearnresultsingle(iniFile,videoSetting, frameSetting,videofile):
    ...
    multiAnimalStatus, multiAnimalIDList = check_multi_animal_status(config=config, noAnimals=animalsNo)
...
#plotsklearnresultsingle("Z:\DeepLabCut\DLC_extract\Troubleshooting\DLC_2_black_060320\project_folder\project_config.ini", 1, 0, 'Together_1.mp4')

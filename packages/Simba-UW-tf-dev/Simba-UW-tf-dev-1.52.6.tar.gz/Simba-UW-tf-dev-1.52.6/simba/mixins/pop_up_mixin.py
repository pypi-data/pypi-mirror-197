    ...
    def create_import_pose_menu(self,
        ...
        def run_call(data_type: str,
            ...
            if self.animal_name_entry_boxes is None:
                print('SIMBA ERROR: Select animal number and animal names BEFORE importing data.')
                raise ValueError('SIMBA ERROR: Select animal number and animal names BEFORE importing data.')

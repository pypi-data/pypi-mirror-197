...
class PrivateRedshiftCluster(
    ...
    def add_database(self, *, database_name: builtins.str) -> None:
        '''
        :param database_name: 

        :stability: experimental
        '''
        props = RedShiftDatabaseProps(database_name=database_name)

        return typing.cast(None, jsii.invoke(self, "addDatabase", [props]))

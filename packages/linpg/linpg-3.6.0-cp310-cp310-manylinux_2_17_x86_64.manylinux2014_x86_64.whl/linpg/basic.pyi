...
class Filters:
    @staticmethod
    def glassmorphism_effect(_surface: ImageSurface, _rect: Optional[tuple[int, int, int, int] | tuple[tuple[int, int], tuple[int, int]]] = ..., whiteness: int = ...) -> ImageSurface: ...
    @staticmethod
...
class FontGenerator:
    ...
    def render(self, txt: str | int, color: color_liked, background_color: Optional[color_liked] = ...) -> ImageSurface: ...
...
class Font:
    ...
    @classmethod
    def render(cls, txt: str | int, color: color_liked, size: int_f, ifBold: bool = ..., ifItalic: bool = ..., background_color: Optional[color_liked] = ...) -> ImageSurface: ...

class ArtisticFont:
    @staticmethod
    def render_description_box(txt: str | int, color: color_liked, size: int, padding: int, background_color: color_liked, ifBold: bool = ..., ifItalic: bool = ..., outline_color: Optional[color_liked] = ..., thickness: int = ...) -> ImageSurface: ...
    @staticmethod

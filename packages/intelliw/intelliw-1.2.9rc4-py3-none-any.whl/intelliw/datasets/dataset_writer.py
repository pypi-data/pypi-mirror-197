...
class DataCommonWriter(AbstractEngineWriter):
    def __init__(self, output_config):
        ...
        self.default_column = ['id', 'train_batch']
        try:
    ...
    def _push_to_source(self, df: pd.DataFrame):
        ...
        for idx in range(0, total, self.batch_size):
            ...
            split_data.insert(1, 'train_batch', self.train_batch)
    ...
    def _push_to_s3(self, df: pd.DataFrame):
        ...
        url = f"{config.DOMIAN_IUAP_AIP_CONSOLE}/self/indexExplain/v1/index/getUploadUrl"
        iuap_request.put_file_to_s3(url, fp, filename=self.train_batch)
        fp.close
        return True

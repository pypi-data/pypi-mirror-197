...
TEMPLATE_TO_NAME_MAP: Dict[WorkspaceStarterTemplate, str] = {
    WorkspaceStarterTemplate.aws_ml_app: "ml-app",
    WorkspaceStarterTemplate.aws_api_app: "api-app",
...
TEMPLATE_TO_REPO_MAP: Dict[WorkspaceStarterTemplate, str] = {
    WorkspaceStarterTemplate.aws_ml_app: "https://github.com/phidatahq/aws-ml-app-template.git",
    WorkspaceStarterTemplate.aws_api_app: "https://github.com/phidatahq/aws-api-app-template.git",
...
def create_workspace_using_input():
    ...
    print_info("Select Template (default: aws-ml-app)")
    ...
    template: WorkspaceStarterTemplate = WorkspaceStarterTemplate.aws_ml_app

...
class TestPruneHelper(unittest.TestCase):
    ...
    def find_pencil_size_from_dense_arr(self, arr: np.ndarray, num_cols_to_inspect=5):
        """
    ...
    def test_pencil_sparsity_pattern(self, pencil_size, prune_scheduler):
        ...
        for layer in model_pruned_stripped.trainable_weights:
            ...
            """
            sparsity_level = calculate_sparsity(layer.numpy())
            eps = 0.08
            ...
            """
            pred_pencil_size = self.find_pencil_size_from_dense_arr(layer.numpy())

...
class Project:
    ...
    def _fetch_solcast_data(self):
        ...
        if self.df_solcast.empty or not self.df.index.equals(self.df_solcast.index):
    ...
    def plot_meters(self):
        ...
        if not self.processed:
            ...
            self._process_data(neighbor_sensor_data={}, get_solcast=False)
    ...
    def _process_data(self, neighbor_sensor_data: dict, get_solcast: bool):
        ...
        if self.year >= 2023:
            self._calculate_data_sub_sensor_averages(neighbor_sensor_data, get_solcast=get_solcast)

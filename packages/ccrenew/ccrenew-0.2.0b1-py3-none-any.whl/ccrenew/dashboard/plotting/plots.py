...
class Plotter:
    def __init__(self, project: Project, neighbor_sensors: dict):
    ...
    def _draw_plot(self, plot_name, plot_params, **kwargs):
        ...
        def draw_multiple_axes(dfs, fig, axs, min_date, max_date):
        ...
        if plot_name.replace(' ', '_').lower() == 'xplot_pwr_poa':
            ...
            draw_multiple_axes([poa, ghi, tamb, tmod, wind], fig, axs, min_date, max_date)

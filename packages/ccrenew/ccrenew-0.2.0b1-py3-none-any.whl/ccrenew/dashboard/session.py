...
class DashboardSession:
    ...
    def process_project(self, project_name:str|Project|list, reprocess:bool = False) -> Project:
        """
        ...
        if isinstance(project_name, list):
            ...
            try:
                project._process_data(neighbor_sensor_data=neighbor_sensor_data, get_solcast=True)
            except Exception:
                print('\n')
                print('###########################')
    ...
    def process_all_projects(self, method:str = 'parallel', reprocess = True):
        """
    ...
    def export_project(self, project_name:str|list, server:str = 'dev', save_pickle:bool = True, dest:str|list = 'all') -> None:
        """
    ...
    def export_projects(self, project_list:list|str, server:str = 'dev', save_pickle:bool = True, dest:str|list = 'all', method:str = 'series') -> None:
    ...
    def draw_plots(self, project_name:str|Project|list, plot_order=[], *args, **kwargs):
        ...
        if isinstance(project_name, (str, Project)):
            ...
            try:
                ...
                plotter = Plotter(project, neighbor_sensors)
                self.plotters[project_name] = plotter

            plotter._update_plotter_neighbors(neighbor_sensors)

...
SERIALIZED_ANIMATION_PATH = Path(gh_utils.get_app_dir()) / "animated_models/serialized/"
...
data_path = SERIALIZED_ANIMATION_PATH.parent
fbx_path = data_path / "fbx"
if not fbx_path.exists():
    fbx_path.mkdir(parents=True)
gltf_path = data_path / "gltf"
if not gltf_path.exists():
    gltf_path.mkdir(parents=True)
...
gh_imgui.file_browser_set_current_directory(str(SERIALIZED_ANIMATION_PATH.parent))

...
def add_GoogleOAuthServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("GoogleOAuth", rpc_method_handlers)
...
def add_YandexOAuthServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("YandexOAuth", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))

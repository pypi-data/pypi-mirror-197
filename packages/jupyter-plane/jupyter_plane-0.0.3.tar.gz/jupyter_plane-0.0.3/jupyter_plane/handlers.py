...
class JupyterPlaneHandler(JupyterHandler):
    """JupyterPlaneHandler"""
    ...
    def get(self):
        self.finish(json.dumps({
            "data": "This is /jupyter_plane/get_example endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_plane", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_plane", "echo")
    handlers = [
        (route_pattern, JupyterPlaneHandler),

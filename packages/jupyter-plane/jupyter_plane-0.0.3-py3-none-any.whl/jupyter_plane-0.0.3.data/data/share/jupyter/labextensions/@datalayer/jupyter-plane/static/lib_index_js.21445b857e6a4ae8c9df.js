"use strict";
(self["webpackChunk_datalayer_jupyter_plane"] = self["webpackChunk_datalayer_jupyter_plane"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'jupyter_plane', // API Namespace
    endPoint);
    let response;
    try {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "IJupyterPlane": () => (/* binding */ IJupyterPlane),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "jupyterPlane": () => (/* binding */ jupyterPlane)
/* harmony export */ });
...
const IJupyterPlane = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_4__.Token('@datalayer/jupyter-plane:plugin');
const jupyterPlane = {
...
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.create = 'create-jupyter-plane-widget';
...
const plugin = {
    ...
    activate: (app, palette, settingRegistry, launcher) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_8__.requestAPI)('get_example')
            ...
            .catch(reason => {
            console.error(`The jupyter_plane server extension appears to be missing.\n${reason}`);
        });
        (0,_ws__WEBPACK_IMPORTED_MODULE_9__.connect)('ws://localhost:8888/jupyter_plane/echo', true);
        return jupyterPlane;
    }
};
...
//# sourceMappingURL=lib_index_js.21445b857e6a4ae8c9df.js.map
...
class RdsApi:
    ...
    def start_export_task(
        ...
        Amazon
        S3 <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/aurora-export-snapshot.html>`__
        in the *Amazon Aurora User Guide*.

        For more information on exporting DB cluster data, see `Exporting DB
        cluster data to Amazon
        S3 <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/export-cluster-data.html>`__
        in the *Amazon Aurora User Guide*.

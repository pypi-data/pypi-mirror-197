...
def awslambda():from localstack.services.awslambda import lambda_starter as A;from localstack_ext.services.awslambda.lambda_extended import LambdaExtLifecycleHook as B,LambdaService as C,patch_lambda as D;D();return C(_A,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,lifecycle_hook=B())
@pro_aws_provider(api=_A,name=_C)
def awslambda_v1():from localstack.services.awslambda import lambda_starter as A;from localstack_ext.services.awslambda.lambda_extended import LambdaExtLifecycleHook as B,LambdaService as C,patch_lambda as D;D();return C(_A,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,lifecycle_hook=B())

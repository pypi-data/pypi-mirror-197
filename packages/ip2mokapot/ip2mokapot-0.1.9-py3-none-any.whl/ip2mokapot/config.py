...
RT_ALIGNMENT_PERCENTILE_DESCRIPTION = 'The xcorr percentile for which to fit the rt alignment function, represented as an integer.'
RT_SCORE_DESCRIPTION = 'Predict RT values for peptides and generate a RT score'
MODIFICATION_MAP_DESCRIPTION = 'Maps the IP2 Modification to its Unitprot ID'

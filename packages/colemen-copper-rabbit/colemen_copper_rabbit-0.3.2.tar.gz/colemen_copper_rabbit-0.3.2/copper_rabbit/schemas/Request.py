...
class CreateRequestSchema(BaseSchema):
    ...
    def __repr__(self):
        return f"<Request_schema:{self.method}-{self.crud_type}-{self.protocol}-{self.ip_address}-{self.description}>"
...
class PublicRequestSchema(BaseSchema):
    ...
    def __repr__(self):
        return f"<Request_schema:{self.request_id}-{self.crud_type}-{self.protocol}-{self.ip_address}-{self.description}>"
...
class UpdateRequestSchema(BaseSchema):
    ...
    def __repr__(self):
        return f"<UpdateRequestSchema:{self.request_id}-{self.crud_type}-{self.protocol}-{self.ip_address}-{self.description}>"
...
class SoftDeleteRequestSchema(BaseSchema):
    ...
    def __repr__(self):
        return f"<SoftDeleteRequestSchema:{self.request_id}-{self.deleted}-{self.modified_timestamp}>"
...
class DeleteRequestSchema(BaseSchema):
    ...
    def __repr__(self):
        return f"<DeleteRequestSchema:{self.request_id}>"

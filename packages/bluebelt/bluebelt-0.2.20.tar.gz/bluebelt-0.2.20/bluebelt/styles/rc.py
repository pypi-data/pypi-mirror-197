...
colors = [black, blue, green, orange, light_blue, yellow, red, dark_blue]
...
plt.rc('axes.spines', left=False)  # display axis spines
...
plt.rc('axes', prop_cycle=(cycler('color', colors))) # color cycle for plot lines

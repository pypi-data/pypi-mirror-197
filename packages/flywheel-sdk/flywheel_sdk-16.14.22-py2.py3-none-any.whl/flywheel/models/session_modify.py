...
class SessionModify(object):
    ...
    def __init__(self, timestamp=None, project=None, subject=None, timezone=None, label=None, info=None, tags=None, permissions=None, age=None, weight=None, operator=None):  # noqa: E501

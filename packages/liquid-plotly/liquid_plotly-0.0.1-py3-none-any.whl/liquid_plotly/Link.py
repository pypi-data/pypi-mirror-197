...
- ariaLabel (string; optional):
    Since b* and xb* variants are uppercase, screen readers need to be
    served a (non-uppercase) aria-label (otherwise they will read out
    the heading letter by letter). If you're using a b* or xb*
    variant, an aria-label will be set automatically on the element.
    The component will use the inner HTML for the label implicitly. If
    you want to set an aria-label explicitly (such as when you have
    inner HTML that should not be part of the label), you can use this
    property.

- chevron (a value equal to: 'start', 'end'; optional):
...
- disabled (boolean; optional):
    The disabled attribute sets `aria-disabled=\"True\"` on the
    rendered anchor element.
...
- style (dict; optional):
    ...
    - MozTextAlignLast (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'center', 'left', 'right', 'justify'; optional):
    ...
    - textAlign (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'left', 'right', 'justify', 'match-parent'; optional):
    ...
    - textAlignLast (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'center', 'left', 'right', 'justify'; optional):
        The **`text-align-last`** CSS property sets how the last line
        of a block or a line, right before a forced line break, is
        aligned.  **Syntax**: `auto | start | end | left | right |
...
- target (a value equal to: '_blank', '_self', '_parent', '_top'; optional):
    ...
    _type = 'Link'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, chevron=Component.UNDEFINED, disabled=Component.UNDEFINED, focusInner=Component.REQUIRED, href=Component.UNDEFINED, key=Component.UNDEFINED, ldTabindex=Component.UNDEFINED, ref=Component.UNDEFINED, target=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'chevron', 'className', 'disabled', 'href', 'key', 'ldTabindex', 'ref', 'slot', 'style', 'target']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'chevron', 'className', 'disabled', 'href', 'key', 'ldTabindex', 'ref', 'slot', 'style', 'target']

...
- threeLayers (boolean; optional):
    Use 3 color layers.

- type (a value equal to: 'bioreliance', 'f', 'functional', 'hexagon', 'mdo', 'millipore', 'milliq', 'o', 'organic', 'plastic', 'qa-x2f-qc', 'safc', 'sigma-aldrich', 'supelco', 'synthetic', 't', 'technical', 'tile'; optional):
    Cells pattern."""
    _children_props = []
    ...
    _type = 'BgCells'
    @_explicitize_args
    def __init__(self, animated=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, threeLayers=Component.UNDEFINED, type=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'animated', 'className', 'key', 'ref', 'slot', 'style', 'threeLayers', 'type']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'animated', 'className', 'key', 'ref', 'slot', 'style', 'threeLayers', 'type']
        ...
        super(BgCells, self).__init__(**args)

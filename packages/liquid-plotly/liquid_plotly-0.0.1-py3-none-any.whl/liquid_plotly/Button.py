...
- children (string | list of a list of or a singular dash component, string or numbers; required):
    The actual content of the element.

- id (string; optional):
    Unique ID to identify this component in Dash callbacks.

- alignText (a value equal to: 'left', 'right'; optional):
    Align text.
...
- brandColor (boolean; optional):
    Style the button so that it looks good on the current theme's
    primary color.
...
- formaction (a value equal to: 'application/x-www-form-urlencoded', 'multipart/form-data', 'text/plain'; optional):
    Overrides the `action` attribute of the button's form owner.

- formenctype (string; optional):
    Overrides the `enctype` attribute of the button's form owner.

- formmethod (a value equal to: 'get', 'post'; optional):
...
- formtarget (a value equal to: '_blank', '_parent', '_self', '_top'; optional):
    Overrides the `target` attribute of the button's form owner.

- href (string; optional):
    Transforms the button to an anchor element. See [mdn
    docs](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#attr-href)
    for more information on the `href` attribute.

- justifyContent (a value equal to: 'start', 'end', 'between'; optional):
    Justify content.
...
- mode (a value equal to: 'highlight', 'secondary', 'ghost', 'danger', 'danger-secondary'; optional):
    Display mode.
...
- style (dict; optional):
    ...
    - KhtmlBoxAlign (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'stretch', 'center', 'baseline'; optional):
    ...
    - KhtmlBoxPack (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'justify'; optional):
    ...
    - MozBoxAlign (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'stretch', 'center', 'baseline'; optional):
        The **`box-align`** CSS property specifies how an element
        aligns its contents across its layout in a perpendicular
        direction. The effect of the property is only visible if there
        is extra space in the box.  **Syntax**: `start | center | end
    ...
    - MozBoxPack (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'justify'; optional):
        The **`-moz-box-pack`** and **`-webkit-box-pack`** CSS
        properties specify how a `-moz-box` or `-webkit-box` packs its
        contents in the direction of its layout. The effect of this is
        only visible if there is extra space in the box.  **Syntax**:
    ...
    - MozTextAlignLast (a value equal to: 'left', 'right', 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'center', 'justify'; optional):
    ...
    - WebkitBoxAlign (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'stretch', 'center', 'baseline'; optional):
        The **`box-align`** CSS property specifies how an element
        aligns its contents across its layout in a perpendicular
        direction. The effect of the property is only visible if there
        is extra space in the box.  **Syntax**: `start | center | end
    ...
    - WebkitBoxPack (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'justify'; optional):
        The **`-moz-box-pack`** and **`-webkit-box-pack`** CSS
        properties specify how a `-moz-box` or `-webkit-box` packs its
        contents in the direction of its layout. The effect of this is
        only visible if there is extra space in the box.  **Syntax**:
    ...
    - appearance (a value equal to: 'button', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'none', 'checkbox', 'listbox', 'menulist', 'meter', 'progress-bar', 'push-button', 'radio', 'searchfield', 'slider-horizontal', 'square-button', 'textarea', 'menulist-button', 'textfield'; optional):
        The **`appearance`** CSS property is used to display an
        element using platform-native styling, based on the operating
        system's theme. The **`-moz-appearance`** and
        **`-webkit-appearance`** properties are non-standard versions
    ...
    - boxAlign (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'stretch', 'center', 'baseline'; optional):
        The **`box-align`** CSS property specifies how an element
        aligns its contents across its layout in a perpendicular
        direction. The effect of the property is only visible if there
        is extra space in the box.  **Syntax**: `start | center | end
    ...
    - boxPack (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'justify'; optional):
        The **`-moz-box-pack`** and **`-webkit-box-pack`** CSS
        properties specify how a `-moz-box` or `-webkit-box` packs its
        contents in the direction of its layout. The effect of this is
        only visible if there is extra space in the box.  **Syntax**:
    ...
    - msWrapFlow (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'both', 'clear', 'maximum'; optional):
    ...
    - rubyAlign (a value equal to: 'start', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'space-around', 'space-between', 'center'; optional):
    ...
    - textAlign (a value equal to: 'left', 'right', 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'justify', 'match-parent'; optional):
    ...
    - textAlignLast (a value equal to: 'left', 'right', 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'center', 'justify'; optional):
        The **`text-align-last`** CSS property sets how the last line
        of a block or a line, right before a forced line break, is
        aligned.  **Syntax**: `auto | start | end | left | right |
    ...
    - textAnchor (a value equal to: 'start', 'end', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'middle'; optional)
...
- target (a value equal to: '_blank', '_parent', '_self', '_top'; optional):
    The `target` attributed can be used in conjunction with the `href`
    attribute. See [mdn
    docs](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#attr-target)
...
- value (string; optional):
    ...
    _type = 'Button'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, autofocus=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, alignText=Component.UNDEFINED, brandColor=Component.UNDEFINED, disabled=Component.UNDEFINED, focusInner=Component.REQUIRED, form=Component.UNDEFINED, formaction=Component.UNDEFINED, formenctype=Component.UNDEFINED, formmethod=Component.UNDEFINED, formnovalidate=Component.UNDEFINED, formtarget=Component.UNDEFINED, href=Component.UNDEFINED, justifyContent=Component.UNDEFINED, key=Component.UNDEFINED, ldTabindex=Component.UNDEFINED, mode=Component.UNDEFINED, name=Component.UNDEFINED, progress=Component.UNDEFINED, ref=Component.UNDEFINED, size=Component.UNDEFINED, target=Component.UNDEFINED, type=Component.UNDEFINED, value=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'alignText', 'ariaLabel', 'autofocus', 'brandColor', 'className', 'disabled', 'form', 'formaction', 'formenctype', 'formmethod', 'formnovalidate', 'formtarget', 'href', 'justifyContent', 'key', 'ldTabindex', 'mode', 'name', 'progress', 'ref', 'size', 'slot', 'style', 'target', 'type', 'value']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'alignText', 'ariaLabel', 'autofocus', 'brandColor', 'className', 'disabled', 'form', 'formaction', 'formenctype', 'formmethod', 'formnovalidate', 'formtarget', 'href', 'justifyContent', 'key', 'ldTabindex', 'mode', 'name', 'progress', 'ref', 'size', 'slot', 'style', 'target', 'type', 'value']

...
- shadow (a value equal to: 'active', 'hover', 'stacked', 'sticky'; optional):
    Simulates card elevation by setting the size of the card box
    shadow.

- shadowInteractive (a value equal to: 'active', 'hover', 'stacked', 'sticky'; optional):
    Adds hover and focus-within states using an elevation transition
    from `shadow` (see above) to `shadowInteractive`.
...
- style (dict; optional):
    ...
    - imeMode (a value equal to: 'active', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'normal', 'disabled', 'inactive'; optional):
    ...
    - msImeMode (a value equal to: 'active', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'normal', 'disabled', 'inactive'; optional):
        The **`ime-mode`** CSS property controls the state of the
        input method editor (IME) for text fields. This property is
        obsolete.  **Syntax**: `auto | normal | active | inactive |
        disabled`  **Initial value**: `auto` @,deprecated.
    ...
    _type = 'Card'
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, size=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, shadow=Component.UNDEFINED, shadowInteractive=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'key', 'ref', 'shadow', 'shadowInteractive', 'size', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'key', 'ref', 'shadow', 'shadowInteractive', 'size', 'slot', 'style']

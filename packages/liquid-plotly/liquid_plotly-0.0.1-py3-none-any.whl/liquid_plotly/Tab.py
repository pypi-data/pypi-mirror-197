...
- selected (boolean; optional):
    If present, this boolean attribute indicates that the tab is
    selected.
...
- style (dict; optional):
    ...
    _type = 'Tab'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, disabled=Component.UNDEFINED, focusInner=Component.REQUIRED, key=Component.UNDEFINED, ldTabindex=Component.UNDEFINED, ref=Component.UNDEFINED, select=Component.REQUIRED, selected=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'disabled', 'key', 'ldTabindex', 'ref', 'selected', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'disabled', 'key', 'ldTabindex', 'ref', 'selected', 'slot', 'style']

...
class TableColgroup(Component):
    """A TableColgroup component.
...
- span (number; optional):
    Contains a non-negative integer value indicating the number of
...
- style (dict; optional):
    ...
    _type = 'TableColgroup'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, span=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'key', 'ref', 'slot', 'span', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'key', 'ref', 'slot', 'span', 'style']
        ...
        super(TableColgroup, self).__init__(children=children, **args)

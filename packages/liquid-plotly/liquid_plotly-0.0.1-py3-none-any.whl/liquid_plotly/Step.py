...
- description (string; optional):
    Description text to display below the step name (vertical mode
    only).
...
- style (dict; optional):
    ...
    - KhtmlBoxOrient (a value equal to: 'vertical', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'horizontal', 'block-axis', 'inline-axis'; optional):
    ...
    - MozBoxOrient (a value equal to: 'vertical', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'horizontal', 'block-axis', 'inline-axis'; optional):
        The **`box-orient`** CSS property sets whether an element lays
        out its contents horizontally or vertically.  **Syntax**:
        `horizontal | vertical | inline-axis | block-axis | inherit`
        **Initial value**: `inline-axis` (`horizontal` in XUL)
    ...
    - MozOrient (a value equal to: 'vertical', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'block', 'inline', 'horizontal'; optional):
    ...
    - WebkitBoxOrient (a value equal to: 'vertical', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'horizontal', 'block-axis', 'inline-axis'; optional):
        The **`box-orient`** CSS property sets whether an element lays
        out its contents horizontally or vertically.  **Syntax**:
        `horizontal | vertical | inline-axis | block-axis | inherit`
        **Initial value**: `inline-axis` (`horizontal` in XUL)
    ...
    - boxOrient (a value equal to: 'vertical', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'horizontal', 'block-axis', 'inline-axis'; optional):
        The **`box-orient`** CSS property sets whether an element lays
        out its contents horizontally or vertically.  **Syntax**:
        `horizontal | vertical | inline-axis | block-axis | inherit`
        **Initial value**: `inline-axis` (`horizontal` in XUL)
    ...
    - resize (a value equal to: 'vertical', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'both', 'none', 'block', 'inline', 'horizontal'; optional):
...
- vertical (boolean; optional):
    ...
    _type = 'Step'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, nextStep=Component.UNDEFINED, style=Component.UNDEFINED, brandColor=Component.UNDEFINED, current=Component.UNDEFINED, description=Component.UNDEFINED, disabled=Component.UNDEFINED, done=Component.UNDEFINED, focusInner=Component.REQUIRED, href=Component.UNDEFINED, icon=Component.UNDEFINED, key=Component.UNDEFINED, labelCurrent=Component.UNDEFINED, labelDone=Component.UNDEFINED, labelOptional=Component.UNDEFINED, labelSkipped=Component.UNDEFINED, labelWasOptional=Component.UNDEFINED, lastActive=Component.UNDEFINED, ldTabindex=Component.UNDEFINED, optional=Component.UNDEFINED, ref=Component.UNDEFINED, size=Component.UNDEFINED, skipped=Component.UNDEFINED, vertical=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'brandColor', 'className', 'current', 'description', 'disabled', 'done', 'href', 'icon', 'key', 'labelCurrent', 'labelDone', 'labelOptional', 'labelSkipped', 'labelWasOptional', 'lastActive', 'ldTabindex', 'nextStep', 'optional', 'ref', 'size', 'skipped', 'slot', 'style', 'vertical']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'brandColor', 'className', 'current', 'description', 'disabled', 'done', 'href', 'icon', 'key', 'labelCurrent', 'labelDone', 'labelOptional', 'labelSkipped', 'labelWasOptional', 'lastActive', 'ldTabindex', 'nextStep', 'optional', 'ref', 'size', 'skipped', 'slot', 'style', 'vertical']

...
- mode (a value equal to: 'error', 'info', 'warning', 'success'; optional):
    Mode of the notice.
...
- style (dict; optional):
    ...
    _type = 'Notice'
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, style=Component.UNDEFINED, headline=Component.UNDEFINED, key=Component.UNDEFINED, mode=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'headline', 'key', 'mode', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'headline', 'key', 'mode', 'ref', 'slot', 'style']
        ...
        super(Notice, self).__init__(children=children, **args)

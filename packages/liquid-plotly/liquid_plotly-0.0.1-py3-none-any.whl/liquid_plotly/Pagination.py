...
- length (number; optional):
    The number of items/pages available for pagination (required to
    let the user jump to the last item/page).

- mode (a value equal to: 'numbers', 'dots'; optional):
...
- selectedIndex (number; optional):
    The currently selected item (an index of `-1` means nothing is
    selected).
...
- space (string; optional):
    Space between dots (dots mode only, default depending on `size`
    prop).
...
- style (dict; optional):
    ...
    - WebkitMaskRepeatX (a value equal to: 'space', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'no-repeat', 'repeat', 'round'; optional):
    ...
    - WebkitMaskRepeatY (a value equal to: 'space', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'no-repeat', 'repeat', 'round'; optional):
    ...
    _type = 'Pagination'
    @_explicitize_args
    def __init__(self, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, brandColor=Component.UNDEFINED, endLabel=Component.UNDEFINED, hidePrevNext=Component.UNDEFINED, hideStartEnd=Component.UNDEFINED, itemLabel=Component.UNDEFINED, key=Component.UNDEFINED, length=Component.UNDEFINED, mode=Component.UNDEFINED, nextLabel=Component.UNDEFINED, offset=Component.UNDEFINED, prevLabel=Component.UNDEFINED, ref=Component.UNDEFINED, selectedIndex=Component.UNDEFINED, size=Component.UNDEFINED, space=Component.UNDEFINED, startLabel=Component.UNDEFINED, sticky=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'ariaLabel', 'brandColor', 'className', 'endLabel', 'hidePrevNext', 'hideStartEnd', 'itemLabel', 'key', 'length', 'mode', 'nextLabel', 'offset', 'prevLabel', 'ref', 'selectedIndex', 'size', 'slot', 'space', 'startLabel', 'sticky', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'ariaLabel', 'brandColor', 'className', 'endLabel', 'hidePrevNext', 'hideStartEnd', 'itemLabel', 'key', 'length', 'mode', 'nextLabel', 'offset', 'prevLabel', 'ref', 'selectedIndex', 'size', 'slot', 'space', 'startLabel', 'sticky', 'style']

...
- style (dict; optional):
    ...
    _type = 'Crumb'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, current=Component.UNDEFINED, href=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'current', 'href', 'key', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'current', 'href', 'key', 'ref', 'slot', 'style']
        ...
        super(Crumb, self).__init__(children=children, **args)

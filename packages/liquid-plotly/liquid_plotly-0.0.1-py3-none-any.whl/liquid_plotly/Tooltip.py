...
- hideDelay (number; optional):
    Delay in ms until tooltip hides (only when trigger type is
    'hover').

- key (string | number; optional):
    for tracking the node's identity when working with lists.

- position (a value equal to: 'bottom center', 'bottom left', 'bottom right', 'left bottom', 'left middle', 'left top', 'right bottom', 'right middle', 'right top', 'top center', 'top left', 'top right'; optional):
    Position of the tooltip relative to the trigger element (also
    affects the arrow position).

- ref (boolean | number | string | dict | list; optional):
    reference to component.

- showDelay (number; optional):
    Delay in ms until tooltip shows (only when trigger type is
    'hover').
...
- triggerType (a value equal to: 'click', 'hover'; optional):
    ...
    _type = 'Tooltip'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, size=Component.UNDEFINED, style=Component.UNDEFINED, arrow=Component.UNDEFINED, disabled=Component.UNDEFINED, hideDelay=Component.UNDEFINED, hideTooltip=Component.REQUIRED, key=Component.UNDEFINED, position=Component.UNDEFINED, ref=Component.UNDEFINED, showDelay=Component.UNDEFINED, showTooltip=Component.REQUIRED, tag=Component.UNDEFINED, tetherOptions=Component.UNDEFINED, triggerType=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'arrow', 'className', 'disabled', 'hideDelay', 'key', 'position', 'ref', 'showDelay', 'size', 'slot', 'style', 'tag', 'tetherOptions', 'triggerType']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'arrow', 'className', 'disabled', 'hideDelay', 'key', 'position', 'ref', 'showDelay', 'size', 'slot', 'style', 'tag', 'tetherOptions', 'triggerType']

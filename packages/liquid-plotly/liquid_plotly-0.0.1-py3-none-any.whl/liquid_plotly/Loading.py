...
- style (dict; optional):
    ...
    _type = 'Loading'
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, label=Component.UNDEFINED, neutral=Component.UNDEFINED, paused=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'key', 'label', 'neutral', 'paused', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'key', 'label', 'neutral', 'paused', 'ref', 'slot', 'style']

...
- variant (a value equal to: 'body-xs', 'body-s', 'body-m', 'body-l', 'body-xl', 'cap-m', 'cap-l', 'label-s', 'label-m', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'b1', 'b2', 'b3', 'b4', 'b5', 'b6', 'xb1', 'xb2', 'xb3', 'xh1', 'xh2', 'xh3', 'xh4', 'xh5', 'xh6'; optional):
    The font style. Every variant has a default tag that it renders
    with."""
    _children_props = []
    ...
    _type = 'Typo'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, tag=Component.UNDEFINED, variant=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'key', 'ref', 'slot', 'style', 'tag', 'variant']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'key', 'ref', 'slot', 'style', 'tag', 'variant']
        ...
        super(Typo, self).__init__(children=children, **args)

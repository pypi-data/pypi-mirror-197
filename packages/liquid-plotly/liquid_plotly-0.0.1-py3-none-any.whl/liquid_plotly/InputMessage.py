...
class InputMessage(Component):
    """An InputMessage component.
...
- mode (a value equal to: 'error', 'info', 'valid'; optional):
    Input message mode.
...
- style (dict; optional):
    ...
    _type = 'InputMessage'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, mode=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'key', 'mode', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'key', 'mode', 'ref', 'slot', 'style']
        ...
        super(InputMessage, self).__init__(children=children, **args)

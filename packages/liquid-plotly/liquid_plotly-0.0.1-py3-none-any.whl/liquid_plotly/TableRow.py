...
- selectable (boolean; optional):
    Makes the row selectable by adding a checkbox to the start of the
    row.

- selected (boolean; optional):
    Indicates that the row is selected.

- selectionDisabled (boolean; optional):
...
- selectionSticky (boolean; optional):
...
- style (dict; optional):
    ...
    _type = 'TableRow'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, indeterminate=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, selectable=Component.UNDEFINED, selected=Component.UNDEFINED, selectionDisabled=Component.UNDEFINED, selectionLabel=Component.UNDEFINED, selectionSticky=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'indeterminate', 'key', 'ref', 'selectable', 'selected', 'selectionDisabled', 'selectionLabel', 'selectionSticky', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'indeterminate', 'key', 'ref', 'selectable', 'selected', 'selectionDisabled', 'selectionLabel', 'selectionSticky', 'slot', 'style']

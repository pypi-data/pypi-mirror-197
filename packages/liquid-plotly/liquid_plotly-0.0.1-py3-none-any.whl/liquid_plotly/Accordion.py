...
- brandColor (boolean; optional):
    Style the accordion so that it looks good on the primary color of
    the current theme.
...
- single (boolean; optional):
    When set to True, an open accordion element closes, if anthorer
    one opens.
...
- tone (string; optional):
    ...
    _type = 'Accordion'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, tone=Component.UNDEFINED, brandColor=Component.UNDEFINED, detached=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, rounded=Component.UNDEFINED, single=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'brandColor', 'className', 'detached', 'key', 'ref', 'rounded', 'single', 'slot', 'style', 'tone']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'brandColor', 'className', 'detached', 'key', 'ref', 'rounded', 'single', 'slot', 'style', 'tone']

...
- hideOnScroll (boolean; optional):
    Hide the header when the user scrolls down and show it again, when
    the user scrolls up.

- key (string | number; optional):
    for tracking the node's identity when working with lists.

- logoTitle (string; optional):
...
- style (dict; optional):
    ...
    - MozBackfaceVisibility (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'visible'; optional):
    ...
    - MozBorderEndStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - MozBorderStartStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - WebkitBackfaceVisibility (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'visible'; optional):
        The **`backface-visibility`** CSS property sets whether the
        back face of an element is visible when turned towards the
        user.  **Syntax**: `visible | hidden`  **Initial value**:
        `visible`.
    ...
    - backfaceVisibility (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'visible'; optional):
        The **`backface-visibility`** CSS property sets whether the
        back face of an element is visible when turned towards the
        user.  **Syntax**: `visible | hidden`  **Initial value**:
    ...
    - borderBlockEndStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - borderBlockStartStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - borderBlockStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - borderBottomStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - borderInlineEndStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
        The **`border-inline-end-style`** CSS property defines the
        style of the logical inline end border of an element, which
        maps to a physical border style depending on the element's
        writing mode, directionality, and text orientation. It
    ...
    - borderInlineStartStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
        The **`border-inline-start-style`** CSS property defines the
        style of the logical inline start border of an element, which
        maps to a physical border style depending on the element's
        writing mode, directionality, and text orientation. It
    ...
    - borderInlineStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - borderLeftStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - borderRightStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - borderTopStyle (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'none', 'dashed', 'dotted', 'double', 'groove', 'inset', 'outset', 'ridge', 'solid'; optional):
    ...
    - contentVisibility (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'visible'; optional):
    ...
    - msOverflowX (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'visible', 'scroll', 'clip', '-moz-hidden-unscrollable'; optional):
    ...
    - msOverflowY (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'visible', 'scroll', 'clip', '-moz-hidden-unscrollable'; optional):
    ...
    - overflowBlock (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'visible', 'scroll', 'clip'; optional):
        **Syntax**: `visible | hidden | clip | scroll | auto`
        **Initial value**: `auto`  | Chrome | Firefox | Safari | Edge
        | IE  | | :----: | :-----: | :----: | :--: | :-: | |   No   |
        **69**  |   No   | n/a  | No  |
    ...
    - overflowInline (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'visible', 'scroll', 'clip'; optional):
        **Syntax**: `visible | hidden | clip | scroll | auto`
        **Initial value**: `auto`  | Chrome | Firefox | Safari | Edge
        | IE  | | :----: | :-----: | :----: | :--: | :-: | |   No   |
        **69**  |   No   | n/a  | No  |
    ...
    - overflowX (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'visible', 'scroll', 'clip', '-moz-hidden-unscrollable'; optional):
        The **`overflow-x`** CSS property sets what shows when content
        overflows a block-level element's left and right edges. This
        may be nothing, a scroll bar, or the overflow content.
        **Syntax**: `visible | hidden | clip | scroll | auto`
    ...
    - overflowY (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'visible', 'scroll', 'clip', '-moz-hidden-unscrollable'; optional):
        The **`overflow-y`** CSS property sets what shows when content
        overflows a block-level element's top and bottom edges. This
        may be nothing, a scroll bar, or the overflow content.
        **Syntax**: `visible | hidden | clip | scroll | auto`
    ...
    - position (a value equal to: 'sticky', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'fixed', '-webkit-sticky', 'absolute', 'relative', 'static'; optional):
    ...
    - visibility (a value equal to: 'hidden', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'visible', 'collapse'; optional):
    ...
    _type = 'Header'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, hidden=Component.UNDEFINED, hideOnScroll=Component.UNDEFINED, key=Component.UNDEFINED, logoTitle=Component.UNDEFINED, logoUrl=Component.UNDEFINED, ref=Component.UNDEFINED, siteName=Component.UNDEFINED, sticky=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'hidden', 'hideOnScroll', 'key', 'logoTitle', 'logoUrl', 'ref', 'siteName', 'slot', 'sticky', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'hidden', 'hideOnScroll', 'key', 'logoTitle', 'logoUrl', 'ref', 'siteName', 'slot', 'sticky', 'style']

...
- event (dict; optional):
    ...
    - name (a value equal to: 'ldSrLiveInfo', 'ldSrLiveAlert'; required)
...
- style (dict; optional):
    ...
    _type = 'SrLive'
    @_explicitize_args
    def __init__(self, className=Component.UNDEFINED, event=Component.UNDEFINED, style=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'event', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'event', 'ref', 'slot', 'style']
        ...
        super(SrLive, self).__init__(**args)

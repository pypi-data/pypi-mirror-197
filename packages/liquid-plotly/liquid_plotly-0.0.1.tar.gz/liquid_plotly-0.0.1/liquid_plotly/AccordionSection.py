...
class AccordionSection(Component):
    """An AccordionSection component.
...
- style (dict; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, style=Component.UNDEFINED, expanded=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'expanded', 'key', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'expanded', 'key', 'ref', 'slot', 'style']
        ...
        super(AccordionSection, self).__init__(children=children, **args)

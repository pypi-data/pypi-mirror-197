...
- colspan (number; optional):
    ...
    columns the cell extends.

- headers (string; optional):
    Contains a list of space-separated strings, each corresponding to
    the id attribute of the table header elements that apply to this
    element.
...
- style (dict; optional):
    ...
    _type = 'TableCell'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, colspan=Component.UNDEFINED, headers=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, rowspan=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'colspan', 'headers', 'key', 'ref', 'rowspan', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'colspan', 'headers', 'key', 'ref', 'rowspan', 'slot', 'style']

...
- mode (a value equal to: 'ghost', 'brand-color', 'floating', 'floating-on-brand-color'; optional):
    Display mode.

- ref (boolean | number | string | dict | list; optional):
    reference to component.

- rounded (a value equal to: 'top', 'all', 'all-lg', 'top-lg'; optional):
    Sets border radii.
...
- style (dict; optional):
    ...
    _type = 'Tablist'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, mode=Component.UNDEFINED, ref=Component.UNDEFINED, rounded=Component.UNDEFINED, size=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'key', 'mode', 'ref', 'rounded', 'size', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'key', 'mode', 'ref', 'rounded', 'size', 'slot', 'style']

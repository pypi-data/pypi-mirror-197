...
class AccordionToggle(Component):
    """An AccordionToggle component.
...
- labelTag (a value equal to: 'button', 'div'; optional):
    Tag to be used for the toggle label in split mode. This prop is
    especially usefull, if you want to place your own focusable
    element inside the toggle label element.
...
- split (boolean; optional):
    Split the toggle in two parts with the second part containing the
    caret icon and being responsible for expanding / collapsing the
    accordion panel.
...
- style (dict; optional):
    ...
    - KhtmlBoxLines (a value equal to: 'single', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'multiple'; optional):
    ...
    - WebkitBoxLines (a value equal to: 'single', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'multiple'; optional):
        The **`box-lines`** CSS property determines whether the box
        may have a single or multiple lines (rows for horizontally
        oriented boxes, columns for vertically oriented boxes).
        **Syntax**: `single | multiple`  **Initial value**: `single`
    ...
    - boxLines (a value equal to: 'single', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'multiple'; optional):
        The **`box-lines`** CSS property determines whether the box
        may have a single or multiple lines (rows for horizontally
        oriented boxes, columns for vertically oriented boxes).
        **Syntax**: `single | multiple`  **Initial value**: `single`
...
- toggleLabel (string; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, style=Component.UNDEFINED, disabled=Component.UNDEFINED, focusInner=Component.REQUIRED, key=Component.UNDEFINED, labelTag=Component.UNDEFINED, ldTabindex=Component.UNDEFINED, ref=Component.UNDEFINED, setExpanded=Component.REQUIRED, split=Component.UNDEFINED, toggleLabel=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'disabled', 'key', 'labelTag', 'ldTabindex', 'ref', 'slot', 'split', 'style', 'toggleLabel']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'disabled', 'key', 'labelTag', 'ldTabindex', 'ref', 'slot', 'split', 'style', 'toggleLabel']
        ...
        super(AccordionToggle, self).__init__(children=children, **args)

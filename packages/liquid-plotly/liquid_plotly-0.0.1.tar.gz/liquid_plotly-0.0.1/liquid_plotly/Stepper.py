...
- fitContent (boolean; optional):
    Indicates whether the steps should be evenly distributed or fit to
    their content.

- key (string | number; optional):
    for tracking the node's identity when working with lists.

- labelSummaryTemplate (string; optional):
    Step summary template for the screen-reader label, containing the
    index of the current step and the overall number of steps.

- labelTemplate (string; optional):
    Template for the screen-reader label, containing the label of the
    current step and the steps summary.
...
- vertical (boolean; optional):
    ...
    _type = 'Stepper'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, brandColor=Component.UNDEFINED, fitContent=Component.UNDEFINED, key=Component.UNDEFINED, labelSummaryTemplate=Component.UNDEFINED, labelTemplate=Component.UNDEFINED, ref=Component.UNDEFINED, size=Component.UNDEFINED, vertical=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'brandColor', 'className', 'fitContent', 'key', 'labelSummaryTemplate', 'labelTemplate', 'ref', 'size', 'slot', 'style', 'vertical']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'brandColor', 'className', 'fitContent', 'key', 'labelSummaryTemplate', 'labelTemplate', 'ref', 'size', 'slot', 'style', 'vertical']

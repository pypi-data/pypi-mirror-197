...
- style (dict; optional):
    ...
    _type = 'Badge'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, className=Component.UNDEFINED, size=Component.UNDEFINED, style=Component.UNDEFINED, brandColor=Component.UNDEFINED, icon=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'brandColor', 'className', 'icon', 'key', 'ref', 'size', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'brandColor', 'className', 'icon', 'key', 'ref', 'size', 'slot', 'style']

...
- event (dict; optional):
    ...
    - detail (dict; optional)
        ...
        `detail` is a dict with keys:

        - content (string; required)

        - timeout (number; optional)

        - type (a value equal to: 'info', 'alert'; optional)

    - name (a value equal to: 'ldNotificationAdd', 'ldNotificationDismiss', 'ldNotificationClear'; required)
...
- style (dict; optional):
    ...
    _type = 'Notification'
    @_explicitize_args
    def __init__(self, className=Component.UNDEFINED, event=Component.UNDEFINED, style=Component.UNDEFINED, placement=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'event', 'placement', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'event', 'placement', 'slot', 'style']

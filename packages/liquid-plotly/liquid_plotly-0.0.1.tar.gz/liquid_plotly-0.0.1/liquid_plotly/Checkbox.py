...
- indeterminate (boolean; optional):
    Set this property to `True` to indicate that the checkbox's value
    is neither True nor False. The prop is removed automatically as
    soon as the checkbox is clicked (if not disabled).

- invalid (boolean; optional):
    Set this property to `True` in order to mark the checkbox visually
    as invalid.
...
- mode (a value equal to: 'highlight', 'danger'; optional):
    Display mode.
...
- required (boolean; optional):
    Set this property to `True` in order to mark the checkbox as
    required.
...
- tone (string; optional):
    Use `'dark'` on white backgrounds. Default is a light tone. Takes
    only effect in conjunction with neutral mode.
...
- value (string; optional):
    ...
    _type = 'Checkbox'
    @_explicitize_args
    def __init__(self, ariaLabel=Component.UNDEFINED, autofocus=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, tone=Component.UNDEFINED, checked=Component.UNDEFINED, disabled=Component.UNDEFINED, focusInner=Component.REQUIRED, form=Component.UNDEFINED, indeterminate=Component.UNDEFINED, invalid=Component.UNDEFINED, key=Component.UNDEFINED, ldTabindex=Component.UNDEFINED, mode=Component.UNDEFINED, name=Component.UNDEFINED, readonly=Component.UNDEFINED, ref=Component.UNDEFINED, required=Component.UNDEFINED, value=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'ariaLabel', 'autofocus', 'checked', 'className', 'disabled', 'form', 'indeterminate', 'invalid', 'key', 'ldTabindex', 'mode', 'name', 'readonly', 'ref', 'required', 'slot', 'style', 'tone', 'value']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'ariaLabel', 'autofocus', 'checked', 'className', 'disabled', 'form', 'indeterminate', 'invalid', 'key', 'ldTabindex', 'mode', 'name', 'readonly', 'ref', 'required', 'slot', 'style', 'tone', 'value']

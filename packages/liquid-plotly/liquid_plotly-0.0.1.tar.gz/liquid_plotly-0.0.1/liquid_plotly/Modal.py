...
- blurryBackdrop (boolean; optional):
    Use a blurry backdrop.

- cancelable (boolean; optional):
    The modal is cancelable by default. However, you can change this
    using this prop.
...
- open (boolean; optional):
    Indicates that the modal dialog is active and can be interacted
    with.
...
- style (dict; optional):
    ...
    _type = 'Modal'
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, slot=Component.UNDEFINED, style=Component.UNDEFINED, blurryBackdrop=Component.UNDEFINED, cancelable=Component.UNDEFINED, close=Component.REQUIRED, key=Component.UNDEFINED, open=Component.UNDEFINED, ref=Component.UNDEFINED, showModal=Component.REQUIRED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'blurryBackdrop', 'cancelable', 'className', 'key', 'open', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'blurryBackdrop', 'cancelable', 'className', 'key', 'open', 'ref', 'slot', 'style']

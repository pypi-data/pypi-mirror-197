...
class CardStack(Component):
    """A CardStack component.
...
- direction (a value equal to: 'ltr', 'rtl', 'vertical'; optional):
    The stack direction.
...
- style (dict; optional):
    ...
    _type = 'CardStack'
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, style=Component.UNDEFINED, direction=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'direction', 'key', 'ref', 'slot', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'direction', 'key', 'ref', 'slot', 'style']
        ...
        super(CardStack, self).__init__(children=children, **args)

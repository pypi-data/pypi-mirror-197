...
- creatable (boolean; optional):
    ...
    This mode allows the user to create new options using the filter
    input field.

- createButtonLabel (string; optional):
    The \"create\" button label (creatable mode).

- createInputLabel (string; optional):
...
- filter (boolean; optional):
    Set this property to `True` in order to enable an input field for
    filtering options.
...
- invalid (boolean; optional):
    Set this property to `True` in order to mark the select visually
    as invalid.
...
- maxRows (number; optional):
    Constrains the height of the trigger button by replacing
    overflowing selection with a \"+X more\" indicator.

- mode (a value equal to: 'inline', 'detached', 'ghost'; optional):
    Display mode.
...
- placeholder (string; optional):
    Used as trigger button label in multiselect mode and in single
    select mode if nothing is selected.

- popperClass (string; optional):
    Attached as CSS class to the select popper element.

- preventDeselection (boolean; optional):
    Prevents a state with no options selected after initial selection
...
- selected (list of dicts; optional):
    Currently selected option(s) (read only!).

    `selected` is a list of dicts with keys:
...
- tetherOptions (boolean | number | string | dict | list; optional):
    Tether options object to be merged with the default options
    (optionally stringified)."""
    _children_props = []
    _base_nodes = ['children']
    _namespace = 'liquid_plotly'
    _type = 'Select'
    @_explicitize_args
    def __init__(self, children=None, ariaLabel=Component.UNDEFINED, autofocus=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, ldTabindex=Component.UNDEFINED, disabled=Component.UNDEFINED, key=Component.UNDEFINED, ref=Component.UNDEFINED, selected=Component.UNDEFINED, size=Component.UNDEFINED, multiple=Component.UNDEFINED, creatable=Component.UNDEFINED, createButtonLabel=Component.UNDEFINED, createInputLabel=Component.UNDEFINED, filter=Component.UNDEFINED, filterPlaceholder=Component.UNDEFINED, focusInner=Component.REQUIRED, form=Component.UNDEFINED, invalid=Component.UNDEFINED, maxRows=Component.UNDEFINED, mode=Component.UNDEFINED, name=Component.UNDEFINED, placeholder=Component.UNDEFINED, popperClass=Component.UNDEFINED, preventDeselection=Component.UNDEFINED, required=Component.UNDEFINED, tetherOptions=Component.UNDEFINED, id=Component.UNDEFINED, slot=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'ariaLabel', 'autofocus', 'className', 'creatable', 'createButtonLabel', 'createInputLabel', 'disabled', 'filter', 'filterPlaceholder', 'form', 'invalid', 'key', 'ldTabindex', 'maxRows', 'mode', 'multiple', 'name', 'placeholder', 'popperClass', 'preventDeselection', 'ref', 'required', 'selected', 'size', 'slot', 'style', 'tetherOptions']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'autofocus', 'className', 'creatable', 'createButtonLabel', 'createInputLabel', 'disabled', 'filter', 'filterPlaceholder', 'form', 'invalid', 'key', 'ldTabindex', 'maxRows', 'mode', 'multiple', 'name', 'placeholder', 'popperClass', 'preventDeselection', 'ref', 'required', 'selected', 'size', 'slot', 'style', 'tetherOptions']

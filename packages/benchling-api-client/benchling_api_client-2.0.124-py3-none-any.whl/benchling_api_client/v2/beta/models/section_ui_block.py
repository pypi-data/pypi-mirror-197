...
class SectionUiBlock:
    ...
    _children: List[
        Union[ButtonUiBlock, ChipUiBlock, MarkdownUiBlock, SearchInputUiBlock, TextInputUiBlock, UnknownType]
    ]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_children() -> List[
            Union[
                ButtonUiBlock, ChipUiBlock, MarkdownUiBlock, SearchInputUiBlock, TextInputUiBlock, UnknownType
            ]
        ]:
            children = []

...
class Zabbix(object):
    ...
    zabbix_api, zabbix_auth = None, None
    ...
    def __init__(self, api, username, password):
        ...
        try:
            ...
            if vTrue(response, dict) and response.get('result'):
                self.zabbix_auth = response['result']
    ...
    def request(self, method, params=None, **kwargs):
        ...
        try:
            ...
            _response = requests.post(self.zabbix_api, headers=self._header, json=_data, timeout=10, **kwargs)

...
def dataset_cardinality(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
...
def dataset_cardinality_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  input_dataset = _ops.convert_to_tensor(input_dataset, _dtypes.variant)

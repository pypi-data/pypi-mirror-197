from typing import Union, Tuple, Literal, Dict, Any, List, TypedDict
...
class _BaseGen384764(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """required"""

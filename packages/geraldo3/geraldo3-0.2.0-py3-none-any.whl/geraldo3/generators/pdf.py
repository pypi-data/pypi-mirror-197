...
try:
    ...
    # http://pypi.python.org/pypi/pyPdf3/
...
from geraldo3.cache import make_hash_key, get_cache_backend, CACHE_DISABLED
...
class PDFGenerator(ReportGenerator):
    ...
    def get_top_pos(self):
        ...
        ret = self.calculate_size(self.report.page_size[1]) - self.calculate_size(

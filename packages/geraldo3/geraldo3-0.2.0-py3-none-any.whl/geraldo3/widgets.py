...
from .base import Element, SubReport
from .utils import get_attr_value, FIELD_ACTION_VALUE, cm
...
class SystemField(Label):
    """This shows system information, like the report title, current date/time,
    ...
    def _text(self):
        page_number = (self.fields.get(
            'page_number') or self.generator._current_page_number) + self.generator.first_page_number - 1

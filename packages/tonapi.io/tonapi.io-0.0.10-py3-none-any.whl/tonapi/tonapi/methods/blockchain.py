...
class Blockchain(TonapiClient):
    ...
    def get_account(self, account: str) -> Account:
        ...
        response = self._request(Method.blockchain.getAccount, params)
    ...
    def get_block(self, block_id: str) -> Block:
        ...
        response = self._request(Method.blockchain.getBlock, params)

        return Block(**response)

    def get_transaction(self, hash_: str) -> Transaction:
        ...
        """
        params = {'hash': hash_}
        response = self._request(Method.blockchain.getTransaction, params)

        return Transaction(**response)

    def get_transactions(self, account: str, max_lt: int = None,
        ...
        response = self._request(Method.blockchain.getTransactions, params)
    ...
    def validators(self) -> Validators:
        ...
        """
        response = self._request(Method.blockchain.validators)

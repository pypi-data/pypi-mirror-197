...
class DNS(TonapiClient):

    def backresolve(self, account: str) -> DomainNames:
        ...
        response = self._request(Method.dns.backresolve, params)

        return DomainNames(**response)

    def domains_search(self, domain: str) -> DomainNames:
        ...
        response = self._request(Method.dns.domains_search, params)

        return DomainNames(**response)

    def get_info(self, name: str) -> DomainInfo:
        """Domain info.
        ...
        """
        params = {'name': name}
        response = self._request(Method.dns.getInfo, params)
    ...
    def resolve(self, name: str) -> DnsRecord:
        ...
        """
        params = {'name': name}
        response = self._request(Method.dns.resolve, params)

...
class NFT(AsyncTonapiClient):
    ...
    async def get_collection(self, account: str) -> NftCollection:
        ...
        response = await self._request(Method.nft.getCollection, params)
    ...
    async def get_collections(self, limit: int = 15, offset: int = 0) -> NftCollections:
        ...
        response = await self._request(Method.nft.getCollections, params)
    ...
    async def get_items(self, addresses: list[str]) -> NftItemsRepr:
        ...
        response = await self._request(Method.nft.getItems, params)
    ...
    async def search_items(self, owner: str = None, collection: str = None,
        ...
        response = await self._request(Method.nft.searchItems, params)

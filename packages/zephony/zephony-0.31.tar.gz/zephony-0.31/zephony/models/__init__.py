...
class BaseModel(db.Model):
    ...
    def __init__(self, data, from_seed_file=False):
        ...
        self.created_at = serialize_datetime(datetime.datetime.now(), datetime_with_microseconds_format)
    ...
    def _get_base_details(self):
        base_details = {
            ...
            'created_at': serialize_datetime(
                self.created_at, datetime_with_microseconds_format
            ),
        }
        if self.last_updated_at:
            base_details['last_updated_at'] = serialize_datetime(
                self.last_updated_at, datetime_with_microseconds_format
            )
        else:

...
An example notebook exploring this dataset can be found [here]({notebook_url})
...
script_url_template = 'https://github.com/paradigm-operations/paradigm-data-portal/blob/main/scripts/generate_{dataset_name}.py'

notebook_url_template = 'https://github.com/paradigm-operations/paradigm-data-portal/blob/main/notebooks/{dataset_name}.py'

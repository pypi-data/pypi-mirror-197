    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=255)),
                ('description', models.CharField(blank=True, max_length=255)),
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='device_partition', to='netbox_storage.linuxdevice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.FloatField()),
                ('description', models.CharField(blank=True, max_length=255)),
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='device_logical_volume', to='netbox_storage.linuxdevice')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),

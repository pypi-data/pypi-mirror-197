...
class TemplateVolumeConfig(PluginTemplateExtension):
    ...
    def right_page(self):
        ...
        for drive_id in drives:
            ...
            linux_device_drive = LinuxDevice.objects.filter(content_type_id=drive_type_id, object_id=drive_id['drive'], type='disk')
            print(f"Count: {linux_device_drive}")
            # Wenn es keine Partition hat zu lonelydrive hinzufügen

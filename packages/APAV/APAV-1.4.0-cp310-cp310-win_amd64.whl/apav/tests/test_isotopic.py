...
class TestIsotope:
    ...
    def test_all_real_elements_true(self):
        ion = Ion("Cu2O")
        assert ion.all_real_elements() is True

    def test_all_real_elements_false(self):
        ion = Ion("BaTy6")
        assert ion.all_real_elements() is False
...
class TestIsotopeSeries:
    ...
    def setup_class(cls):
        ...
        cls.o_iso_series = IsotopeSeries(cls.o_ion, isotopes=cls.o_isos, threshold=0)

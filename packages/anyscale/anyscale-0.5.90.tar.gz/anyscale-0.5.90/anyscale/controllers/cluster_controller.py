...
class ClusterController(BaseController):
    ...
    def start(  # noqa: PLR0912, PLR0913
        ...
        try:
            ...
            # _get_project_id_and_cluster_name will raise a ClickException if the
            # cloud_name is None and the cluster doesn't exist per the cluster and project
            # arguments and cloud isolation is enabled. Because we don't expect the
            # cluster to exist at this stage, set existing_cluster=None.
    ...
    def terminate(
        ...
        project_id, cluster_name = self._get_project_id_and_cluster_name(
            cluster_id, project_id, cluster_name, project_name, cloud_id, cloud_name
        )

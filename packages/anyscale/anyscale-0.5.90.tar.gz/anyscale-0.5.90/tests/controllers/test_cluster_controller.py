...
def test_start(mock_auth_api_client, needs_start: bool, cluster_exists: bool) -> None:
    ...
    assert cluster_controller._get_project_id_and_cluster_name.call_count == 2
    cluster_controller._get_project_id_and_cluster_name.assert_any_call(
        "cluster_id", None, None, None, cloud_id=None, cloud_name=None
    )
    cluster_controller._get_project_id_and_cluster_name.assert_any_call(
        "cluster_id",
        "mock_project_id",

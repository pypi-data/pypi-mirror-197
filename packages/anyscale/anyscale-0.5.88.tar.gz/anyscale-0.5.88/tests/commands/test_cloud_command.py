...
from frontend.cli.anyscale.commands.cloud_commands import setup_cloud
...
def test_cloud_setup(use_legacy_stack):
    ...
    with patch(
        "frontend.cli.anyscale.commands.cloud_commands.CloudController",
        new=mock_cloud_controller,
    ):

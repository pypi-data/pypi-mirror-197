...
class CloudController(BaseController):
    ...
    def delete_cloud(
        ...
        confirm(
            f"If the cloud {cloud_id} is deleted, you will not be able to access existing clusters of this cloud.\nFor more information on deleting an Anyscale cloud on AWS, please refer to the documentation https://docs.anyscale.com/user-guide/onboard/clouds/deploy-on-aws#delete-an-anyscale-cloud\nContinue?",
            skip_confirmation,
        )

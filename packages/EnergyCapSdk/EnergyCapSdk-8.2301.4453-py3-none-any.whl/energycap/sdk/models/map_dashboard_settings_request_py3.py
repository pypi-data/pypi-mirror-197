...
class MapDashboardSettingsRequest(Model):
    ...
    :type title: str
    :param description: Required. The description of the dashboard. <span
     class='property-internal'>Required (defined)</span>
    ...
    def __init__(self, *, title: str, description: str, show_cost: bool=None, show_use: bool=None, show_ghg: bool=None, map_dashboard_filter=None, global_commodity_display: str=None, fixed_commodity_ids=None, **kwargs) -> None:

...
def owl_to_fhir(
    ...
    out_dir = out_dir if (out_dir and len(out_dir) > 0) else os.path.dirname(input_path) if not url else os.getcwd()
    # TODO: fix missing outdir
    print('out_dir: ', out_dir)
    print('input_path: ', input_path)
    print('os.path.dirname(input_path): ', os.path.dirname(input_path))

...
[![License](https://img.shields.io/pypi/l/pokedream.svg)](https://github.com/Gorialis/pokedream/blob/master/LICENSE)
[![Status](https://img.shields.io/pypi/status/pokedream.svg)](https://pypi.python.org/pypi/pokedream)
[![Issues](https://img.shields.io/github/issues/Gorialis/pokedream.svg?colorB=3333ff)](https://github.com/Gorialis/pokedream/issues)
[![Commit activity](https://img.shields.io/github/commit-activity/w/Gorialis/pokedream.svg)](https://github.com/Gorialis/pokedream/commits)
...
<br>
<sup>
    <a href="https://pokedream.readthedocs.io/">Read the documentation online.</a>
</sup>
</p>
...
> From GitHub:
> ```bash
> pip install -U "pokedream @ git+https://github.com/Gorialis/pokedream@master"
> ```
> From GitLab:
> ```bash
> pip install -U "pokedream @ git+https://gitlab.com/Gorialis/pokedream@master"
> ```
...
> From GitHub:
> ```bash
> pip install -U --force-reinstall "pokedream @ git+https://github.com/Gorialis/pokedream@master"
> ```
> From GitLab:
> ```bash
> pip install -U --force-reinstall "pokedream @ git+https://gitlab.com/Gorialis/pokedream@master"
> ```

...
class Connection(object):
    ...
    def set_or_update_caches(self, is_cache_set: bool):
        """
        To enable to disable the caches.
        :param is_cache_set: bool
        """
        self._client.setOrUnsetCaches(sessionId=self.get_session_id, bIsCacheSet=is_cache_set)

...
class MSData:
    ...
    def plotBPC(self, pltName, fontsize=20, dpi=300):
        """
        ...
        plt.plot(self.rtBPC, self.intensityBPC, color="black", linewidth=1, dpi=dpi)
        plt.xlabel("Retention time, min", fontname='Arial', fontsize=fontsize, labelpad=5)
        plt.ylabel("Intensity, %", fontname='Arial', fontsize=fontsize, labelpad=5)
...
def outputGradientFig(name, gradient, timePoints, fontsize=20, dpi=600):
    """
    ...
    plt.plot(timePoints, gradient, color="black", linewidth=1, dpi=dpi)
    plt.xlabel("Retention time, min", fontname='Arial', fontsize=fontsize, labelpad=2)
    plt.ylabel("Mobile phase, %", fontname='Arial', fontsize=fontsize, labelpad=2)
    plt.xticks(fontname='Arial', fontsize=fontsize)

...
class MSData:
    ...
    def plotBPC(self, pltName, fontsize=20, dpi=300, figsize=(6, 4)):
        """
...
def outputGradientFig(name, gradient, timePoints, fontsize=20, dpi=600, figsize=(6, 4)):
    """

...
class EnrollServices:
    ...
    def enroll_list(params, filter_fields=None, need_pagination=True):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "id", "thread_id", "category_id", "category_id_list", "thread_id_list", "trading_relate", "region_code", "spend_time_start",
                "enroll_status_code",
            ...
            alias_dict={
                ...
                "thread_id_list": "thread_id__in", "category_id_list": "category_id__in"
            }
        )

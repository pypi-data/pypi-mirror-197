...
from sklearn.metrics import confusion_matrix, f1_score, classification_report, average_precision_score, roc_curve, precision_recall_curve, auc, precision_recall_fscore_support

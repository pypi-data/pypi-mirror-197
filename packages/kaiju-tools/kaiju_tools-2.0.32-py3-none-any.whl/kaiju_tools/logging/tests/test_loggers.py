...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('TextFormatter', {}),
        ('DataFormatter', {'debug': True, 'output_data': False, 'output_context': False}),
        ('DataFormatter', {'debug': True, 'output_context': False}),
        ('DataFormatter', {'debug': True}),
    ],
    ids=['Text minimal', 'Text + data', 'Text + all', 'Json minimal', 'Json + data', 'Json + all'],
)

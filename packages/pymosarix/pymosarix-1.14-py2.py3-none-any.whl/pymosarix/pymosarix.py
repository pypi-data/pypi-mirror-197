...
class pymosarix( image2D_proj):
    def __init__(self):
       ...
       # self.p3.addWidget(self.saveBtn4, row=1+1, col=1)
        ...
        NbrROIS_ = self.param['NbrROIS']
        self.img2D= image2D_proj(data, NbrROIS_)
    ...
    def openfileoffline(self):
        ...
        if self.param['integ']:
                self.img2D.data= self.cubedata.sum(0)
        else:
        ...
        self.img2D.data[manual_mask] = np.NaN
        ...
        self.img2D.data[edge_mask] = np.NaN
    ...
    def openfileoffline22(self):
        ...
        energies = fileim.get_node('/root.spyc.config1d_RIXS_0001/GALAXIES/scan_record/MotorPos1').read()
    ...
    def auto_calibbtn(self):
        ...
        e1 =0# self.param2['firstenergy']
        e2 =10 #self.param2['lastenergy']
        e3 = 10#self.param2['lastenergy']
        de = 1#self.param2['energystep']

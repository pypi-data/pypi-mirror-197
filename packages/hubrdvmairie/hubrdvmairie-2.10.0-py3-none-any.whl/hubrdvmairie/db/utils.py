            ...
            decrypted_offline_meeting_points.append(
                {
                    ...
                    "longitude": float(main_sheet.cell(row=i, column=2).value),
                    "latitude": float(main_sheet.cell(row=i, column=3).value),
                    "public_entry_address": main_sheet.cell(row=i, column=4).value,
                    "zip_code": main_sheet.cell(row=i, column=5).value,
                    "city_name": main_sheet.cell(row=i, column=6).value,
                    "website": main_sheet.cell(row=i, column=7).value,
                    "logo": main_sheet.cell(row=i, column=8).value,
                }
            )
            meeting_point_id += 1
        else:

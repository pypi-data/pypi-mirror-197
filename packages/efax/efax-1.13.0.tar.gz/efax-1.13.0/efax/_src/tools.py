...
from tjax import ComplexArray, JaxRealArray, NumpyComplexArray, NumpyRealArray, RealNumeric
...
def iv(v: RealNumeric, z: RealNumeric) -> JaxRealArray:
...
# Private functions --------------------------------------------------------------------------------
def _parameter_dot_product(x: ComplexArray, y: ComplexArray, n_axes: int) -> JaxRealArray:

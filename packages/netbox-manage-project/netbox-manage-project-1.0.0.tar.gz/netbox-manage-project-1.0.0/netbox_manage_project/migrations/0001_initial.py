    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quota_template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='project_quota', to='netbox_manage_project.quotatemplate')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),

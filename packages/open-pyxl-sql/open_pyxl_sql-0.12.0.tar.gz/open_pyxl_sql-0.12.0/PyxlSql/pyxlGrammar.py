...
from PyxlSql.pyxlEngine import Cmd,\
    ...
    SaveCmd, DeleteCmd, UpdateCmd, SelectIntoCmd, ImportCmd, RenameCmd, LoadCmd, \
...
class Parser:
    ...
    def __init__(self, runner: AbstractRunner):
        ...
        self.add(CmdToken(self.runner, ImportCmd,
                          sub_tokens=[StringToken(self.runner, "Module"), [[KeywordToken(self.runner, "SUBS"), StringToken(self.runner, "submodules")], []]]))
        ...
        self.add(CmdToken(self.runner, SaveCmd,
                          sub_tokens=[StringToken(self.runner, "Filename"), [[],
                                                                [KeywordToken(self.runner, "FROM"), StringToken(self.runner, "Sheet")]]]))

        # TODO: Pivot_cmd      := "PIVOT" dst_field "FROM" src_sheet

...
class TestedWb:
    ...
    def assert_sheet_exists(sql: SqlWb, sheet_name: str):
        ...
        assert msg and (sheet is not None)
    ...
    def assert_error_start(err_nb: int, start: str):
        ...
        assert msg and PyxlSqlError.error_list[err_nb].startswith(start)
    ...
    def assert_warning_start(warning_nb: int, start: str):
        ...
        assert msg and PyxlSqlError.warning_count >= warning_nb
        ...
        assert msg and PyxlSqlError.warning_list[warning_nb].startswith(start)

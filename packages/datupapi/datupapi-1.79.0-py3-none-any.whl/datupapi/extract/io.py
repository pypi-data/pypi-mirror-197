...
class IO(Config):
    ...
    def populate_bigquery_table(self, df, project_id=None, tenant_id=None, table_name=None, gcp_key='datup-supplyai-dev-gcp.json'):
        """
    ...
    def populate_bigquery_table_with_schema(self, df, project_id=None, tenant_id=None, table_name=None, gcp_key='datup-supplyai-dev-gcp.json'):
        """
        Create a table in BigQuery DWH and insert the records from a dataframe
        :param df: Dataframe storing the records to insert into the database table
        :param projectId: Project identifier in GCP

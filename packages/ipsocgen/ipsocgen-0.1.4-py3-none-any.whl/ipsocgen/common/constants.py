...
class options:
    TYPES               = ['soc', 'mpsoc']
    sch_cfg             = 'ipsocgen/common/schemas/schema_config.yaml'
    sch_master          = 'ipsocgen/common/schemas/schema_master.yaml'
    sch_slave           = 'ipsocgen/common/schemas/schema_slave.yaml'

...
# Install OpenJDK 11 if it is not already installed
try:
    import jdk
    jdk.install('11')
except:
    print('Could not install OpenJDK 11. Please install OpenJDK 11 manually and try again')
    print('https://openjdk.java.net/install/')
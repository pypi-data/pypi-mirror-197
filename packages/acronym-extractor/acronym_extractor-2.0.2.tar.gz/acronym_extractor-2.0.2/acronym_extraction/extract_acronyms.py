...
try:
    ...
    raise RuntimeError("Tika JVM failed to initialize. Make sure Java is installed and the Tika server is running.") from e


try:
    nltk.download('stopwords')
except Exception as e:
    raise RuntimeError("NLTK failed to download stopwords.") from e

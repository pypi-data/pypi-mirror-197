...
class UnifiClient(AbstractUnifiSession):
    ...
    def authorize_guest(self, client_mac, minutes, site=None, ap_mac=None, up_speed=None, down_speed=None, MB_limit=None):
        ...
        r = self.post(self.endpoint('/api/s/%s/cmd/stamgr' % site), json=data, timeout=2)
    ...
    def stat_device(self, site, macs=None):
        ...
        '''
        json = {"macs": macs}
        r = self.post(self.endpoint('/api/s/{}/stat/device' .format(site)), json=json, timeout=2)
        return self.process_response(r)
    ...
    def stat_reportAp(self, site, date_range, macs=None, interval='daily', attrs=None):
        ...
        if (attrs == None):
            ...
            data["attrs"] = attrs
        r = self.post(self.endpoint('/api/s/{}/stat/report/{}.ap' .format(site, interval)), json=data, timeout=2)
        return self.process_response(r)

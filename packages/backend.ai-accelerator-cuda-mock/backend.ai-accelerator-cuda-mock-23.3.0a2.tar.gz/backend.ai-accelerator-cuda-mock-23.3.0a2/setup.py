...
setup(**{
    ...
    'install_requires': (
        'aiodocker~=0.21.0',
        'backend.ai-agent==23.03.0a2',
        'backend.ai-cli==23.03.0a2',
        'backend.ai-common==23.03.0a2',
        'backend.ai-kernel-binary==23.03.0a2',
        'backend.ai-kernel-helper==23.03.0a2',
        'backend.ai-kernel==23.03.0a2',
        'backend.ai-plugin==23.03.0a2',
        'trafaret~=2.1',
    ),
    'license': 'LGPLv3',

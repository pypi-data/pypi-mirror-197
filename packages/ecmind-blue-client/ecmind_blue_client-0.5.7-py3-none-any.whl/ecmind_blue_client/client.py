...
from .const import ImportActions, Jobs, MainTypeId, StoreInCacheByIdConversion, SystemFields, FieldSchema
from .job import Job
...
class Client(ABC):
    ...
    def lol_query(
        ...
        By default, only the defined fields will be return if `result_fields` is not empty resp. only the defined fields if `result_fields` is not empty.
        https://ecm.community/t/lol-query-systemfields-auch-mit-schema-all/375
        """

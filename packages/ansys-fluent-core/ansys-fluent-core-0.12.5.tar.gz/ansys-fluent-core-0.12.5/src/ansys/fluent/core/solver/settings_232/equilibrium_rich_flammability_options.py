...
from .rich_equivalence_ratio_limit import rich_equivalence_ratio_limit
from .exponential_factor_beta import exponential_factor_beta
class equilibrium_rich_flammability_options(Group):
    ...
    rich_equivalence_ratio_limit: rich_equivalence_ratio_limit = rich_equivalence_ratio_limit
    """
    rich_equivalence_ratio_limit child of equilibrium_rich_flammability_options.
    """
    exponential_factor_beta: exponential_factor_beta = exponential_factor_beta
    """

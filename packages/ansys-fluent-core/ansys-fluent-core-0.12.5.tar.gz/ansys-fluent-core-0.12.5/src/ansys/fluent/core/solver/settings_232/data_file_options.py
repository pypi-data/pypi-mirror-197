...
from .reset_defined_derived_quantities import reset_defined_derived_quantities
from .derived_quantities import derived_quantities
class data_file_options(Command):
    ...
    reset_defined_derived_quantities: reset_defined_derived_quantities = reset_defined_derived_quantities
    """
    reset_defined_derived_quantities argument of data_file_options.
    """
    derived_quantities: derived_quantities = derived_quantities
    """

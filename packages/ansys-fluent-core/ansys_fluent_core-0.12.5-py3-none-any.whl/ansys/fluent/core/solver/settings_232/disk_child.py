...
from .list_disk_properties import list_disk_properties
class disk_child(Group):
    ...
    child_names = \
        ['general', 'geometry', 'trimming', 'list_disk_properties']
    ...
    """
    list_disk_properties: list_disk_properties = list_disk_properties
    """
    list_disk_properties child of disk_child.
    """

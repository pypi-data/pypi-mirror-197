...
from .gupta_curve_fit_conductivity import gupta_curve_fit_conductivity
...
class thermal_conductivity(Group):
    ...
    """
    gupta_curve_fit_conductivity: gupta_curve_fit_conductivity = gupta_curve_fit_conductivity
    """

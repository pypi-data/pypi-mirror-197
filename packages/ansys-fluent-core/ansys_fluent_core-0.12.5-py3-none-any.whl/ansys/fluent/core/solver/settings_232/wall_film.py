...
from .convective_heat_transfer import convective_heat_transfer
from .include_convective_heat_transfer import include_convective_heat_transfer
from .film_movement import film_movement
...
class wall_film(Group):
    ...
    child_names = \
        ['convective_heat_transfer', 'include_convective_heat_transfer',
         'film_movement', 'include_lwf_particles_in_dpm_concentration',
         'wall_film_temperature_limiter']

    convective_heat_transfer: convective_heat_transfer = convective_heat_transfer
    """
    ...
    """
    film_movement: film_movement = film_movement
    """

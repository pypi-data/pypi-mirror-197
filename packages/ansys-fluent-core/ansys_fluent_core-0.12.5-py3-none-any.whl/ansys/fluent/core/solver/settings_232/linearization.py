...
from .enable_enhanced_linearization import enable_enhanced_linearization
...
class linearization(Group):
    ...
    child_names = \
        ['keep_linearized_source_terms_constant', 'linearize_source_terms',
         'enable_enhanced_linearization', 'linearized_source_terms_limiter']
    ...
    """
    enable_enhanced_linearization: enable_enhanced_linearization = enable_enhanced_linearization
    """
    enable_enhanced_linearization child of linearization.
    """

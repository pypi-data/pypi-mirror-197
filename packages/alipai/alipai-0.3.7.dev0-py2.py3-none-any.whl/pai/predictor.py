...
class Predictor(PredictorBase):
    """Predictor is responsible for make prediction to an online prediction service.
    ...
    Examples::
        ...
        # Initialize a predictor object from an existing service using XGBoost
        # processor.
        xgb_predictor = Predictor(service_name="xgb_example_service")
        result: List = xgb_predictor.predict([[22,33,44], [19,22,33]])
        ...
        **kwargs,
        ...
        Args:
            ...
            serializer (SerializerBase, optional): A serializer object that transforms
                the input Python object for transmission and deserialize the response
                data to Python object.
    ...
    def _post_init_serializer(self, force=False):
        """Post-initialize the serializer by invoke serializer.inspect_from_service"""
    ...
    def predict(self, data):
        """Make a prediction against the online prediction service.
        ...
        deserialized using the `serializer.deserialize` method before the method
        returns.
        ...
        Raises:
            PredictionException: Raise If status code of the prediction response is not
                equals 200.
        """
        ...
        if isinstance(data, Request):
            return self._predict_by_request(data)
    ...
    def raw_predict(self, data: bytes) -> bytes:
        ...
        Returns:
            bytes: Prediction result in bytes returns by the service.
    ...
    def inspect_model_signature_def(self):
        ...
        Returns:
            Dict[str, Any]: A dictionary representing the signature def of the
                serving model.
    ...
    def _predict_by_request(self, req: Request) -> Response:
        return self._client.predict(req)

    def describe_service(self) -> Dict[str, Any]:
        """Describe the service that refers by the predictor.
    ...
    def _get_default_serializer(self):
        ...
        from pai.serializers import JsonSerializer, TorchSerializer
    ...
    def _wait_for_status(
        ...
        while True:
            ...
            if cur_status == status:
                ...
                # if service.status and service.message is not changed,
                # do not print the service status/message.
                pass
            else:
                print_msg(
...
class LocalPredictor(PredictorBase):
    ...
    def __init__(self, port, container_id=None, serializer=None, prediction_route=None):
    ...
    def _build_container_run(self, container_id, port):

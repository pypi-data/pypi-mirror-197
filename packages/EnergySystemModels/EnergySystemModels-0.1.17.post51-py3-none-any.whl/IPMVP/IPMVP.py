...
def regression_model(X_bl,y_bl,approache):
    ...
    return model,y_pred,df,conformite
...
##########################################################################################################################""
    ...
    model_bl,y_pred,df,conformite=regression_model(X_bl,y_bl,"ANTE-POST") 

    model_report,y_pred_report,df_report,conformite_report=regression_model(X_report,y_report,"POST-ANTE") 
    ...
    return  y_pred,df,conformite,y_pred_report,df_report,conformite_report,df_savings

...
@LastEditTime: 2023-03-16 17:19:07
...
class TaskBaseModel(FrameBaseModel):
    ...
    def process_secret_code(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,secret_code,check_new_user=False,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """
    ...
    def process_crm_point_exchange_asset(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,mix_nick,access_token,app_key,app_secret,check_new_user=False,check_user_nick=True,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """

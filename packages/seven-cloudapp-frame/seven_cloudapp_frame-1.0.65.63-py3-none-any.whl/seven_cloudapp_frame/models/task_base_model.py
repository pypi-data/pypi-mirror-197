...
@LastEditTime: 2023-03-16 10:42:10
...
class TaskBaseModel(FrameBaseModel):
    ...
    def process_invite_user_help(self,app_id,act_id,module_id,user_id,login_token,from_user_id,handler_name,continue_request_expire=5,check_act_info_release=True,check_act_module_release=True):
        """
    ...
    def process_secret_code(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,secret_code,check_new_user=False,check_user_nick=False,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """
    ...
    def process_crm_point_exchange_asset(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_code,mix_nick,access_token,app_key,app_secret,check_new_user=False,check_user_nick=False,continue_request_expire=5,is_stat=True,info_json=None,is_receive_reward=True):
        """
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    elif top_base_model.get_crm_point_available(mix_nick, access_token, app_key, app_secret, user_info_dict["open_id"]) < need_crm_point:
                        invoke_result_data.success = False
                        invoke_result_data.error_code = "error"

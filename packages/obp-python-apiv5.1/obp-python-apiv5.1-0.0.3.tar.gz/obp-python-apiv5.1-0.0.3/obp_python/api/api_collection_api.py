...
class ApiCollectionApi(object):
    ...
    def o_bpv5_1_0_get_all_api_collections(self, **kwargs):  # noqa: E501
        """Get All API Collections  # noqa: E501

        <p>Get All API Collections.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_get_all_api_collections(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.o_bpv5_1_0_get_all_api_collections_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.o_bpv5_1_0_get_all_api_collections_with_http_info(**kwargs)  # noqa: E501
            return data

    def o_bpv5_1_0_get_all_api_collections_with_http_info(self, **kwargs):  # noqa: E501
        """Get All API Collections  # noqa: E501

        <p>Get All API Collections.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_get_all_api_collections_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method o_bpv5_1_0_get_all_api_collections" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def o_bpv5_1_0_update_my_api_collection(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_update_my_api_collection(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.o_bpv5_1_0_update_my_api_collection_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.o_bpv5_1_0_update_my_api_collection_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def o_bpv5_1_0_update_my_api_collection_with_http_info(self, body, **kwargs):  # noqa: E501
        """Update My Api Collection By API_COLLECTION_ID  # noqa: E501

        <p>Update Api Collection for logged in user.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_update_my_api_collection_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method o_bpv5_1_0_update_my_api_collection" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `o_bpv5_1_0_update_my_api_collection`")  # noqa: E501

...
class AccountInformationServiceAISApi(object):
    ...
    def o_bpv5_1_0_mtls_client_certificate_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_mtls_client_certificate_info(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.o_bpv5_1_0_mtls_client_certificate_info_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.o_bpv5_1_0_mtls_client_certificate_info_with_http_info(**kwargs)  # noqa: E501
            return data

    def o_bpv5_1_0_mtls_client_certificate_info_with_http_info(self, **kwargs):  # noqa: E501
        """Provide client's certificate info of a current call  # noqa: E501

        <p>Provide client's certificate info of a current call specified by PSD2-CERT value at Request Header</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_mtls_client_certificate_info_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method o_bpv5_1_0_mtls_client_certificate_info" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def o_bpv5_1_0_revoke_consent_at_bank(self, consent_id, bank_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_revoke_consent_at_bank(consent_id, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.o_bpv5_1_0_revoke_consent_at_bank_with_http_info(consent_id, bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.o_bpv5_1_0_revoke_consent_at_bank_with_http_info(consent_id, bank_id, **kwargs)  # noqa: E501
            return data

    def o_bpv5_1_0_revoke_consent_at_bank_with_http_info(self, consent_id, bank_id, **kwargs):  # noqa: E501
        """Revoke Consent at Bank  # noqa: E501

        <p>Revoke Consent specified by CONSENT_ID</p><p>There are a few reasons you might need to revoke an application’s access to a user’s account:<br />- The user explicitly wishes to revoke the application’s access<br />- You as the service provider have determined an application is compromised or malicious, and want to disable it<br />- etc.</p><p>OBP as a resource server stores access tokens in a database, then it is relatively easy to revoke some token that belongs to a particular user.<br />The status of the token is changed to &quot;REVOKED&quot; so the next time the revoked client makes a request, their token will fail to validate.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_revoke_consent_at_bank_with_http_info(consent_id, bank_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method o_bpv5_1_0_revoke_consent_at_bank" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'consent_id' is set
        if self.api_client.client_side_validation and ('consent_id' not in params or
                                                       params['consent_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `consent_id` when calling `o_bpv5_1_0_revoke_consent_at_bank`")  # noqa: E501
        # verify the required parameter 'bank_id' is set
        if self.api_client.client_side_validation and ('bank_id' not in params or
                                                       params['bank_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bank_id` when calling `o_bpv5_1_0_revoke_consent_at_bank`")  # noqa: E501
    ...
    def o_bpv5_1_0_self_revoke_consent(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_self_revoke_consent(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.o_bpv5_1_0_self_revoke_consent_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.o_bpv5_1_0_self_revoke_consent_with_http_info(**kwargs)  # noqa: E501
            return data

    def o_bpv5_1_0_self_revoke_consent_with_http_info(self, **kwargs):  # noqa: E501
        """Revoke Consent used in the Current Call  # noqa: E501

        <p>Revoke Consent specified by Consent-Id at Request Header</p><p>There are a few reasons you might need to revoke an application’s access to a user’s account:<br />- The user explicitly wishes to revoke the application’s access<br />- You as the service provider have determined an application is compromised or malicious, and want to disable it<br />- etc.</p><p>OBP as a resource server stores access tokens in a database, then it is relatively easy to revoke some token that belongs to a particular user.<br />The status of the token is changed to &quot;REVOKED&quot; so the next time the revoked client makes a request, their token will fail to validate.</p><p>Authentication is Mandatory</p>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.o_bpv5_1_0_self_revoke_consent_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method o_bpv5_1_0_self_revoke_consent" % key
                )
            params[key] = val
        del params['kwargs']

...
"periodic_table.csv" "common_formulas.csv"


PERIODIC_TABLE = pd.read_csv(importlib.resources.open_text("chemic", "periodic_table.csv"))
FORMULA_TABLE = pd.read_csv(importlib.resources.open_text("chemic", "common_formulas.csv"))

...
GITHUB_BUTTON="""<a href="https://github.com/uncenter/chemic" target"_blank" type="button" class="text-white bg-[#24292F] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2 my-4">

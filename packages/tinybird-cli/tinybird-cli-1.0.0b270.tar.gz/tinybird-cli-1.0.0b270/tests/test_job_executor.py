...
class TestJobExecutor(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        self.job_executor_producer = JobExecutor(redis_client=redis_client, redis_kwargs=redis_kwargs, consumer=False, import_workers=0, query_workers=0, export_workers=0)
        self.job_executor_consumer = JobExecutor(redis_client=redis_client, redis_kwargs=redis_kwargs, consumer=True, import_workers=1, query_workers=1, export_workers=1)
